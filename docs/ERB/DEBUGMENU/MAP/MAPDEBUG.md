# DEBUGMENU/MAP/MAPDEBUG.ERB — 自动生成文档

源文件: `ERB/DEBUGMENU/MAP/MAPDEBUG.ERB`

类型: .ERB

自动摘要: functions: MAPDEBUG, DEBUG_SELECT_MAPID, DELETE_MAP_STATUS_DEBUG, PRINT_MAPDEBUG_MENU, PRINTBUTTON_SHOP_DEBUG, PRINT_MAPDEBUG_MENU_EMPTYLINE, SHOP_AVAIL_MAPDEBUG_SET, DRAW_CITY_BUTTON_MAPDEBUG, RESET_MAPDEBUG_STATUS, SHOW_CITY_INFO_MAPDEBUG, PRINT_MAPDEBUG_ROUTE, GET_ROUTECOUNT, DEBUG_CHECK_MAP_CONNECTION; assigns RESULTS; UI/print
