# SHOP/SHOP_LIFE/SHOP_LIFE65_婚姻の儀.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/SHOP_LIFE65_婚姻の儀.ERB`

类型: .ERB

自动摘要: functions: SHOP_LIFE_NAME65, SHOP_LIFE_CHECK65, SHOP_LIFE_CHECKCHARA65, SHOP_LIFE_EVENTBUY65, SHOP_LIFE_EVENTBUY_SHOW65, SHOP_LIFE_USERSHOP65, IS_HUSBAND, HAS_WIFE; assigns RESULTS; UI/print
...
CALL COLUMN_RIGHT_PRINTL
IF HAS_WIFE()
	CALL COLOR_PRINT(" 高好感度で恋人か烙印所持の士官を妾(夫)にできます", カラー_注釈)
ELSE
	CALL COLOR_PRINT(" 高好感度で恋人か烙印所持の士官を正妻（夫）にできます", カラー_注釈)
ENDIF
CALL COLUMN_RIGHT_PRINTL
CALL COLUMN_RIGHT_LINE
CALL COLUMN_RIGHT_PRINTL
