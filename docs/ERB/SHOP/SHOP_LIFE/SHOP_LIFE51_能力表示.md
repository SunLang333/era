# SHOP/SHOP_LIFE/SHOP_LIFE51_能力表示.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/SHOP_LIFE51_能力表示.ERB`

类型: .ERB

自动摘要: functions: SHOP_LIFE_NAME51, SHOP_LIFE_CHECK51, SHOP_LIFE_CHECKCHARA51, SHOP_LIFE_EVENTBUY51, SHOP_LIFE_LIST1_BUTTON51, SHOP_LIFE_EVENTBUY_SHOW51, SHOP_LIFE_EVENTBUY_SUB51, SHOP_LIFE_USERSHOP51, CHARALIST_MODE, SELECTED_SHOWDATA, 性癖一括変更; assigns RESULTS; UI/print; definition/data
...
CALL PRINTBUTTON_EX(" 4[スキル表示]", 4, 1, FLAG:能力表示モード == 4)
IF ARG:1
	PRINTL
	PRINTBUTTON " 7[前のキャラ]", 7
	PRINTBUTTON " 8[次のキャラ]", 8
ENDIF
PRINTL 
