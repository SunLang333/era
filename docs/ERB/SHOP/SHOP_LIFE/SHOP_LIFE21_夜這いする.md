# SHOP/SHOP_LIFE/SHOP_LIFE21_夜這いする.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/SHOP_LIFE21_夜這いする.ERB`

类型: .ERB

自动摘要: functions: SHOP_LIFE_NAME21, SHOP_LIFE_CHECK21, SHOP_LIFE_CHECKCHARA21, SHOP_LIFE_CHECK_ADDITIONAL_CHECK21, SHOP_LIFE_CHECKCHARA_SUB21, YOBAI_ABLE, YOBAI_ZYOSYU_CALC_POINT, YOBAI_TARGET_CALC_POINT, SHOP_LIFE_EVENTBUY21, SHOP_LIFE_LIST1_BUTTON21, SHOP_LIFE_LIST2_BUTTON21, SHOP_LIFE_BUTTON_ADD_TOP21, SHOP_LIFE_BUTTON_ADD_BOTTOM21, SHOP_LIFE_EVENTBUY_SHOW21, SHOP_LIFE_EVENTBUY_SUB21, SHOP_LIFE_USERSHOP21, SHOP_LIFE_USERSHOP_SUB21; assigns RESULTS; UI/print
...
#FUNCTION
RETURNF ABL:ARG:武闘 + ABL:ARG:知略 + FIND_PASSIVE_SKILL(ARG, "工作員") * 30
...
LOCAL = (ABL:ARG:武闘 + ABL:ARG:知略) + FIND_PASSIVE_SKILL(ARG, "工作員") * 10
...
PRINTFORM 助手を最大{MIN(2, CALC_SHOP_TIME() - SHOP_TIME)}人まで連れて行く事が可能です
