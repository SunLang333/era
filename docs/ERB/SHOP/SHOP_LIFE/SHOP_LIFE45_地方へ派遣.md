# SHOP/SHOP_LIFE/SHOP_LIFE45_地方へ派遣.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/SHOP_LIFE45_地方へ派遣.ERB`

类型: .ERB

自动摘要: functions: SHOP_LIFE_NAME45, SHOP_LIFE_CHECK45, SHOP_LIFE_CHECKCHARA45, SHOP_LIFE_EVENTBUY45, SHOP_LIFE_EVENTBUY_SHOW45, SHOP_LIFE_USERSHOP45; assigns RESULTS; UI/print
...
CALL COLOR_PRINT(" 好感を得た汎用キャラを地方へ派遣し、能力に応じて経済力と兵力を得ます", カラー_注釈)
CALL COLUMN_RIGHT_PRINTL
CALL COLOR_PRINT(" 派遣したキャラは削除され二度と戻って来ません", カラー_選択中)
CALL COLUMN_RIGHT_PRINTL
CALL COLUMN_RIGHT_LINE
CALL COLUMN_RIGHT_PRINTL
;標準的なキャラリストとページ移動
