# SHOP/SHOP_LIFE/SHOP_LIFE46_士官を募る.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/SHOP_LIFE46_士官を募る.ERB`

类型: .ERB

自动摘要: functions: SHOP_LIFE_NAME46, SHOP_LIFE_CHECK46, SHOP_LIFE_EVENTBUY46, SHOP_LIFE_USERSHOP_COLUMN_RIGHT_CONVERT_CHARANUM_OFF_CHECK46, SHOP_LIFE_EVENTBUY_SHOW46, SHOP_LIFE_EVENTBUY_SUB46, SHOP_LIFE_USERSHOP46; assigns RESULTS; UI/print
...
PRINTPLAIN   
CALL COLOR_PRINT(" 期の初めのみ募集できます", カラー_注釈)
CALL COLUMN_RIGHT_PRINTL
CALL COLUMN_RIGHT_LINE
CALL COLUMN_RIGHT_PRINTL
