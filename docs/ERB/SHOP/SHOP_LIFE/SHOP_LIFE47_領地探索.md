# SHOP/SHOP_LIFE/SHOP_LIFE47_領地探索.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/SHOP_LIFE47_領地探索.ERB`

类型: .ERB

自动摘要: functions: SHOP_LIFE_NAME47, SHOP_LIFE_CHECK47, SHOP_LIFE_CHECKCHARA47, SHOP_LIFE_EVENTBUY47, SHOP_LIFE_EVENTBUY_SHOW47, SHOP_LIFE_EVENTBUY_SUB47, SHOP_LIFE_USERSHOP47, SELECT_CHARA_RANDOM_LOGIC_FOR_TERRITORY_EXPLORING_BASE; assigns RESULTS; UI/print
...
CALL COLUMN_RIGHT_PRINTL
PRINTBUTTON @"[危険な探索 \@ TERRITORY_EXPLORING_DANGER_EVENT ? オン # オフ \@]", 1

PRINT   
IF TERRITORY_EXPLORING_DANGER_EVENT
	CALL COLOR_PRINT("強制的に貞操を喪うイベントが発生します", カラー_注釈)
ELSE
	CALL COLOR_PRINT("強制的に貞操を喪うイベントは起きません", カラー_注釈)
ENDIF
CALL COLUMN_RIGHT_PRINTL
CALL COLUMN_RIGHT_LINE
CALL COLUMN_RIGHT_PRINTL
