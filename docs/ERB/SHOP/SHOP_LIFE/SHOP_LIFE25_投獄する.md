# SHOP/SHOP_LIFE/SHOP_LIFE25_投獄する.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/SHOP_LIFE25_投獄する.ERB`

类型: .ERB

自动摘要: functions: SHOP_LIFE_NAME25, SHOP_LIFE_CHECK25, SHOP_LIFE_CHECKCHARA25, SHOP_LIFE_EVENTBUY25, SHOP_LIFE_EVENTBUY_SHOW25, SHOP_LIFE_USERSHOP25; assigns RESULTS; UI/print
...
RETURN ARG:0 != MASTER && CFLAG:(ARG:0):所属 == CFLAG:MASTER:所属 && CFLAG:ARG:捕虜先 == 0 && ARG:0 != GET_COUNTRY_BOSS(CFLAG:MASTER:所属) && !IS_ANIMAL(ARG:0) &&
 CFLAG:(ARG:0):行動不能状態 != 行動不能_子供 && !IS_SP_CHARA(ARG:0)
}
...
CALL COLUMN_RIGHT_TITLE("対象者選択(投獄した相手には嫌われます)", "0", "1", "0", "0")
