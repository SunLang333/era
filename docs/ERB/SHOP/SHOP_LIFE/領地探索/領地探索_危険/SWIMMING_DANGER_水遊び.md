# SHOP/SHOP_LIFE/領地探索/領地探索_危険/SWIMMING_DANGER_水遊び.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_危険/SWIMMING_DANGER_水遊び.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_SWIMMING_DANGER_EXISTS, TERRITORY_EVENT_SWIMMING_DANGER_DECISION, TERRITORY_EVENT_SWIMMING_DANGER; UI/print
