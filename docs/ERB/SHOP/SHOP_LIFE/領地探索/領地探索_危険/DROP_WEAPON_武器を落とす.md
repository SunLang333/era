# SHOP/SHOP_LIFE/領地探索/領地探索_危険/DROP_WEAPON_武器を落とす.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_危険/DROP_WEAPON_武器を落とす.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_DROP_WEAPON_EXISTS, TERRITORY_EVENT_DROP_WEAPON_DECISION, TERRITORY_EVENT_DROP_WEAPON; UI/print
