# SHOP/SHOP_LIFE/領地探索/領地探索_危険/GOBLIN_THIEF_DANGER_盗みを働く小鬼.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_危険/GOBLIN_THIEF_DANGER_盗みを働く小鬼.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_GOBLIN_THIEF_DANGER_EXISTS, TERRITORY_EVENT_GOBLIN_THIEF_DANGER_DECISION, TERRITORY_EVENT_GOBLIN_THIEF_DANGER; UI/print
...
CALL FUCK(対象, "欲望, 奉仕, 性技, 性交, 精愛, Ｃ, Ｖ, Ｂ, Ａ, Ｍ, 輪姦, Ｖ性交, Ａ性交", "キス喪失, 処女喪失, Ａ処女喪失, 膣内射精, 腸内射精, CFLAG減少", GET_SPERM_ID("小鬼"), @"小鬼の\@RAND:2 ? ペニス # 唇\@", "小鬼", "", "敗北した末の輪姦")
PRINTFORML
