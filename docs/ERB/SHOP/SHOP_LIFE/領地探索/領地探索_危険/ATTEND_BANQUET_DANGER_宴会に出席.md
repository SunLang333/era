# SHOP/SHOP_LIFE/領地探索/領地探索_危険/ATTEND_BANQUET_DANGER_宴会に出席.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_危険/ATTEND_BANQUET_DANGER_宴会に出席.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_ATTEND_BANQUET_DANGER_EXISTS, TERRITORY_EVENT_ATTEND_BANQUET_DANGER_DECISION, TERRITORY_EVENT_ATTEND_BANQUET_DANGER; UI/print
