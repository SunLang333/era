# SHOP/SHOP_LIFE/領地探索/領地探索_危険/ARROGANT_SOLDIER_横柄な兵士.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_危険/ARROGANT_SOLDIER_横柄な兵士.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_ARROGANT_SOLDIER_EXISTS, TERRITORY_EVENT_ARROGANT_SOLDIER_DECISION, TERRITORY_EVENT_ARROGANT_SOLDIER; UI/print
...
ELSE
	...
	CALL FUCK(対象, "欲望, 奉仕, 精愛, 性技, 性交, Ｃ, Ｖ, Ｂ, Ａ, Ｍ, キス, 口淫, 輪姦, Ｖ性交, Ａ性交, 苦痛快楽", "処女喪失, Ａ処女喪失, 膣内射精, キス喪失, 腸内射精, 口内射精, CFLAG減少", GET_SPERM_ID("兵士"), @"兵士の\@RAND:2 ? ペニス # 唇\@", "兵士", "", "輪姦")
	PRINTFORML 
