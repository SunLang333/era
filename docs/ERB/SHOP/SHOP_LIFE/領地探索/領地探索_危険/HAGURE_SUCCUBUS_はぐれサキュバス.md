# SHOP/SHOP_LIFE/領地探索/領地探索_危険/HAGURE_SUCCUBUS_はぐれサキュバス.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_危険/HAGURE_SUCCUBUS_はぐれサキュバス.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_HAGURE_SUCCUBUS_EXISTS, TERRITORY_EVENT_HAGURE_SUCCUBUS_DECISION, TERRITORY_EVENT_HAGURE_SUCCUBUS; UI/print
...
IF IS_MALE(対象) || (HAS_PENIS(対象) && RAND:2 == 0)
	...
	CALL FUCK(対象, "性技, 性交, Ｃ, 射精, Ｖ挿入" + (IS_FEMALE(対象) ? ", Ｂ, Ｖ, レズ" # "") , "童貞喪失, キス喪失, CFLAG減少", 0, "サキュバスの唇", "", "サキュバスの膣", "敗北した末の強姦")
ELSE
	...
	CALL FUCK(対象, "性技, 性交, Ｃ, Ｂ, Ｖ, レズ", "キス喪失, CFLAG減少", 0, "サキュバスの唇", "", "", "強姦")
ENDIF
PRINTFORML 
