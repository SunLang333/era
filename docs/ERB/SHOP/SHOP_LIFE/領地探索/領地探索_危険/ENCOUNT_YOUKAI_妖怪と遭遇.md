# SHOP/SHOP_LIFE/領地探索/領地探索_危険/ENCOUNT_YOUKAI_妖怪と遭遇.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_危険/ENCOUNT_YOUKAI_妖怪と遭遇.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_ENCOUNT_YOUKAI_EXISTS, TERRITORY_EVENT_ENCOUNT_YOUKAI_DECISION, TERRITORY_EVENT_ENCOUNT_YOUKAI; UI/print
...
SELECTCASE RESULT
	...
	CASE 2
		...
		ELSE
			...
			CALL FUCK(対象, "欲望, 性交, 精愛, Ｖ, Ａ, 苦痛快楽, マゾ, Ｖ性交, Ａ性交", "膣内射精, 処女喪失, Ａ処女喪失, 腸内射精, CFLAG減少", GET_SPERM_ID("野良妖怪"), @"野良妖怪の\@RAND:2 ? ペニス # 唇\@", "野良妖怪", "", "敗北した末の強姦")
			PRINTFORML 
