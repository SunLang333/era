# SHOP/SHOP_LIFE/領地探索/領地探索_危険/STRAY_GOBLIN_DANGER_はぐれゴブリン.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_危険/STRAY_GOBLIN_DANGER_はぐれゴブリン.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_STRAY_GOBLIN_DANGER_EXISTS, TERRITORY_EVENT_STRAY_GOBLIN_DANGER_DECISION, TERRITORY_EVENT_STRAY_GOBLIN_DANGER; UI/print
