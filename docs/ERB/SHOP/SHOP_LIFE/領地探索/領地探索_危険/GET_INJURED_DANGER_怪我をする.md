# SHOP/SHOP_LIFE/領地探索/領地探索_危険/GET_INJURED_DANGER_怪我をする.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_危険/GET_INJURED_DANGER_怪我をする.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_GET_INJURED_DANGER_EXISTS, TERRITORY_EVENT_GET_INJURED_DANGER_DECISION, TERRITORY_EVENT_GET_INJURED_DANGER; UI/print
...
ELSE
	...
	CALL FUCK(対象, "欲望, 奉仕, 精愛, 性技, 性交, Ｃ, Ｖ, Ｂ, Ａ, Ｍ, キス, 口淫, Ｖ性交, Ａ性交", "処女喪失, Ａ処女喪失, 膣内射精, キス喪失, 腸内射精, 口内射精, CFLAG減少", GET_SPERM_ID("医者"), @"医者の\@RAND:2 ? ペニス # 唇\@", "医者", "", "前後不覚に陥った末の強姦")
	PRINTFORML 
