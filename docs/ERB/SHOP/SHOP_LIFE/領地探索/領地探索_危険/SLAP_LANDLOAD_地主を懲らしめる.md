# SHOP/SHOP_LIFE/領地探索/領地探索_危険/SLAP_LANDLOAD_地主を懲らしめる.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_危険/SLAP_LANDLOAD_地主を懲らしめる.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_SLAP_LANDLOAD_EXISTS, TERRITORY_EVENT_SLAP_LANDLOAD_DECISION, TERRITORY_EVENT_SLAP_LANDLOAD; UI/print
...
CALL FUCK(対象, "欲望, 奉仕, 性交, 精愛, Ｖ, Ｂ, Ｃ, Ａ, キス, 口淫, Ｖ性交, Ａ性交", "処女喪失, Ａ処女喪失, キス喪失, 膣内射精, 腸内射精, 口内射精, CFLAG減少", GET_SPERM_ID("地主"), @"地主の\@RAND:2 ? ペニス # 唇\@", "地主", "", "調教")
PRINTFORML 
