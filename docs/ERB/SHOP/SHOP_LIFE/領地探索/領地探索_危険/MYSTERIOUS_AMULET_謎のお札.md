# SHOP/SHOP_LIFE/領地探索/領地探索_危険/MYSTERIOUS_AMULET_謎のお札.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_危険/MYSTERIOUS_AMULET_謎のお札.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_MYSTERIOUS_AMULET_EXISTS, TERRITORY_EVENT_MYSTERIOUS_AMULET_DECISION, TERRITORY_EVENT_MYSTERIOUS_AMULET; UI/print
