# SHOP/SHOP_LIFE/領地探索/領地探索_危険/ENCOUNT_ROBBERY_2_強盗に遭遇_2.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_危険/ENCOUNT_ROBBERY_2_強盗に遭遇_2.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_ENCOUNT_ROBBERY_2_EXISTS, TERRITORY_EVENT_ENCOUNT_ROBBERY_2_DECISION, TERRITORY_EVENT_ENCOUNT_ROBBERY_2, TERRITORY_EVENT_ENCOUNT_ROBBERY_2_FUCK; UI/print
...
PRINTFORML 
CALL FUCK(対象, "欲望, 奉仕, 精愛, 性技, 性交, Ｃ, Ｖ, Ｂ, Ａ, Ｍ, Ｖ性交, Ａ性交, 口淫", "処女喪失, Ａ処女喪失, キス喪失, 膣内射精, 腸内射精, 口内射精, CFLAG減少", GET_SPERM_ID("強盗"), @"強盗の\@RAND:2 ? ペニス # 唇\@", "強盗", "","ねぐらでの調教")
PRINTFORML 
