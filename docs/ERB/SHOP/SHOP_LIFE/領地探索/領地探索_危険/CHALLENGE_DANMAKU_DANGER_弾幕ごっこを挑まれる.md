# SHOP/SHOP_LIFE/領地探索/領地探索_危険/CHALLENGE_DANMAKU_DANGER_弾幕ごっこを挑まれる.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_危険/CHALLENGE_DANMAKU_DANGER_弾幕ごっこを挑まれる.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_CHALLENGE_DANMAKU_DANGER_EXISTS, TERRITORY_EVENT_CHALLENGE_DANMAKU_DANGER_DECISION, TERRITORY_EVENT_CHALLENGE_DANMAKU_DANGER; UI/print
...
CALL FUCK(対象, "欲望, 性交, 奉仕, 性技, Ｖ, Ｍ, キス, 口淫, Ｖ性交", "処女喪失, 膣内射精, キス喪失, 口内射精, CFLAG減少", GET_SPERM_ID("野良妖怪"), @"野良妖怪の\@RAND:2 ? ペニス # 唇\@", "野良妖怪", "", "敗北した末の強姦")
PRINTFORML 
