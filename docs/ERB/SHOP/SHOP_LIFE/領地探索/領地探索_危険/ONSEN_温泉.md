# SHOP/SHOP_LIFE/領地探索/領地探索_危険/ONSEN_温泉.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_危険/ONSEN_温泉.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_ONSEN_EXISTS, TERRITORY_EVENT_ONSEN_DECISION, TERRITORY_EVENT_ONSEN; UI/print
...
SELECTCASE RESULT
	CASE 0
		...
		ELSE
			...
			CALL FUCK(対象, "欲望, 奉仕, 精愛, 性技, 性交, 露出, Ｃ, Ｖ, Ｂ, Ｍ, キス, 口淫, Ｖ性交", "処女喪失, 膣内射精, キス喪失, 口内射精, CFLAG減少", GET_SPERM_ID("痴漢"), @"痴漢の\@RAND:2 ? ペニス # 唇\@", "痴漢", "", "温泉での輪姦")
		ENDIF
	CASE 1
		IF IS_MALE(対象)
	...
	CASE 2
		...
		ELSE
			...
			CALL FUCK(対象, "欲望, 性交, 奉仕, 性技, Ｂ, Ｖ, Ｍ, Ｃ, Ａ, Ｖ性交, Ａ性交", "キス喪失, 処女喪失, Ａ処女喪失, 膣内射精, 腸内射精, CFLAG減少", GET_SPERM_ID("店主"), @"店主の\@ RAND:2 ? 唇 # ペニス\@", "店主", "", "温泉での和姦")
		ENDIF
	CASE 3
