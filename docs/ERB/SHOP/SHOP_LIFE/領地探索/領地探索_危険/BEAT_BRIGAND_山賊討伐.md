# SHOP/SHOP_LIFE/領地探索/領地探索_危険/BEAT_BRIGAND_山賊討伐.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_危険/BEAT_BRIGAND_山賊討伐.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_BEAT_BRIGAND_EXISTS, TERRITORY_EVENT_BEAT_BRIGAND_DECISION, TERRITORY_EVENT_BEAT_BRIGAND; UI/print
...
#DIM 対象
PRINTFORML この辺りで山賊が現れて困っているらしい
...
IF RESULT == 1
	...
	PRINTFORMW 領民には悪いが拠点に帰ることにした
	RETURN 1
ENDIF

PRINTFORML 見逃すことはできない
PRINTFORML %ANAME(対象)%は山賊の討伐に向かった
PRINTFORML ・
PRINTFORML ・
PRINTFORMW ・
...
PRINTFORML 
PRINTFORML %ANAME(対象)%は山賊の慰み者にされている
...
CALL FUCK(対象, "欲望, 奉仕, 性技, 性交, 精愛, Ｃ, Ｖ, Ｂ, Ａ, Ｍ, 輪姦, Ｖ性交, Ａ性交", "キス喪失, 処女喪失, Ａ処女喪失, 膣内射精, 腸内射精, CFLAG減少", GET_SPERM_ID("山賊"), @"山賊の\@RAND:2 ? ペニス # 唇\@", "山賊", "", "敗北した末の輪姦")
PRINTFORML 
