# SHOP/SHOP_LIFE/領地探索/領地探索_危険/REST_UNDER_A_TREE_DANGER_木陰で休憩.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_危険/REST_UNDER_A_TREE_DANGER_木陰で休憩.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_REST_UNDER_A_TREE_DANGER_EXISTS, TERRITORY_EVENT_REST_UNDER_A_TREE_DANGER_DECISION, TERRITORY_EVENT_REST_UNDER_A_TREE_DANGER; UI/print
...
ELSE
	...
	ELSE
		...
		CALL FUCK(対象, "欲望, 精愛, 性交, Ｃ, Ｖ, Ｂ, 緊縛, 苦痛快楽, マゾ, Ｖ性交", "処女喪失, 膣内射精, CFLAG減少", GET_SPERM_ID("野良妖怪"), @"野良妖怪の\@RAND:2 ? ペニス # 唇\@", "野良妖怪", "", "強姦")
		PRINTFORML
