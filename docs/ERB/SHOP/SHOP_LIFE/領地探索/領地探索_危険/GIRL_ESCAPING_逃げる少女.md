# SHOP/SHOP_LIFE/領地探索/領地探索_危険/GIRL_ESCAPING_逃げる少女.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_危険/GIRL_ESCAPING_逃げる少女.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_GIRL_ESCAPING_EXISTS, TERRITORY_EVENT_GIRL_ESCAPING_DECISION, TERRITORY_EVENT_GIRL_ESCAPING; UI/print
...
SELECTCASE RESULT
	CASE 0
		...
		ELSE
			...
			CALL FUCK(対象, "欲望, 奉仕, 精愛, 性技, 性交, Ｃ, Ｖ, Ｂ, Ａ, Ｍ, キス, 口淫, 緊縛, マゾ, Ｖ性交, Ａ性交, 輪姦", "処女喪失, Ａ処女喪失, 膣内射精, キス喪失, 腸内射精, 口内射精, CFLAG減少", GET_SPERM_ID("ごろつき"), @"ごろつきの\@RAND:2 ? ペニス # 唇\@", "ごろつき", "", "ねぐらでの輪姦")
			PRINTFORML 
