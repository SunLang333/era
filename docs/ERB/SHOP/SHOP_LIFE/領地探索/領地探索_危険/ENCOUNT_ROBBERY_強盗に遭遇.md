# SHOP/SHOP_LIFE/領地探索/領地探索_危険/ENCOUNT_ROBBERY_強盗に遭遇.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_危険/ENCOUNT_ROBBERY_強盗に遭遇.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_ENCOUNT_ROBBERY_EXISTS, TERRITORY_EVENT_ENCOUNT_ROBBERY_DECISION, TERRITORY_EVENT_ENCOUNT_ROBBERY; UI/print
...
SELECTCASE RESULT
	...
	CASE 1
		...
		ELSE
			...
			CALL FUCK(対象, "欲望, 欲望, 性交, 性交, Ｖ, Ｖ性交", "処女喪失, 膣内射精, CFLAG減少", GET_SPERM_ID("ならず者"), @"ならず者の\@RAND:2 ? ペニス # 唇\@", "ならず者", "", "身代わりになっての強姦")
			PRINTFORML 
