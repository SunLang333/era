# SHOP/SHOP_LIFE/領地探索/領地探索_危険/BEAT_A_YOUKAI_DANGER_妖怪討伐.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_危険/BEAT_A_YOUKAI_DANGER_妖怪討伐.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_BEAT_A_YOUKAI_DANGER_EXISTS, TERRITORY_EVENT_BEAT_A_YOUKAI_DANGER_DECISION, TERRITORY_EVENT_BEAT_A_YOUKAI_DANGER; UI/print
...
ELSE
	...
	CALL FUCK(対象, "欲望, 性交, Ｖ, Ｖ性交", "処女喪失, 膣内射精, CFLAG減少", GET_SPERM_ID("野良妖怪"), "", "野良妖怪", "", "敗北した末の強姦")
	PRINTFORML 
