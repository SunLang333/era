# SHOP/SHOP_LIFE/領地探索/領地探索_危険/ATTEND_BANQUET_DANGER_2_宴会に出席_2.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_危険/ATTEND_BANQUET_DANGER_2_宴会に出席_2.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_ATTEND_BANQUET_DANGER_2_EXISTS, TERRITORY_EVENT_ATTEND_BANQUET_DANGER_2_DECISION, TERRITORY_EVENT_ATTEND_BANQUET_DANGER_2; UI/print
...
CALL FUCK(対象, "欲望, 性交, 奉仕, 奉仕, Ｖ, Ｂ, Ｃ, Ｖ性交, 輪姦", "キス喪失, 処女喪失, 膣内射精, CFLAG減少", GET_SPERM_ID("ならず者"), @"ならず者の\@RAND:2 ? ペニス # 唇\@", "ならず者", "", "前後不覚に陥った末の輪姦")
PRINTFORML 
