# SHOP/SHOP_LIFE/領地探索/領地探索_通常/FLOWER_GARDEN_花畑.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/FLOWER_GARDEN_花畑.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_FLOWER_GARDEN_EXISTS, TERRITORY_EVENT_FLOWER_GARDEN_DECISION, TERRITORY_EVENT_FLOWER_GARDEN; UI/print
