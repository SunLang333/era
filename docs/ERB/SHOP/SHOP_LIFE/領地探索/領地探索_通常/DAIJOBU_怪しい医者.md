# SHOP/SHOP_LIFE/領地探索/領地探索_通常/DAIJOBU_怪しい医者.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/DAIJOBU_怪しい医者.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_DAIJOBU_EXISTS, TERRITORY_EVENT_DAIJOBU_DECISION, TERRITORY_EVENT_DAIJOBU; UI/print
