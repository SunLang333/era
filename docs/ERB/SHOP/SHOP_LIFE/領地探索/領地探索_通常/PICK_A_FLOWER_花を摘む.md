# SHOP/SHOP_LIFE/領地探索/領地探索_通常/PICK_A_FLOWER_花を摘む.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/PICK_A_FLOWER_花を摘む.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_PICK_A_FLOWER_EXISTS, TERRITORY_EVENT_PICK_A_FLOWER_DECISION, TERRITORY_EVENT_PICK_A_FLOWER; UI/print
