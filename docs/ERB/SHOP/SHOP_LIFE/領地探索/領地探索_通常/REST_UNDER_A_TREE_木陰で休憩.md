# SHOP/SHOP_LIFE/領地探索/領地探索_通常/REST_UNDER_A_TREE_木陰で休憩.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/REST_UNDER_A_TREE_木陰で休憩.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_REST_UNDER_A_TREE_EXISTS, TERRITORY_EVENT_REST_UNDER_A_TREE_DECISION, TERRITORY_EVENT_REST_UNDER_A_TREE; UI/print
