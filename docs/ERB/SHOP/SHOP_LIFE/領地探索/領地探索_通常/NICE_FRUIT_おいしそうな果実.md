# SHOP/SHOP_LIFE/領地探索/領地探索_通常/NICE_FRUIT_おいしそうな果実.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/NICE_FRUIT_おいしそうな果実.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_NICE_FRUIT_EXISTS, TERRITORY_EVENT_NICE_FRUIT_DECISION, TERRITORY_EVENT_NICE_FRUIT; UI/print
