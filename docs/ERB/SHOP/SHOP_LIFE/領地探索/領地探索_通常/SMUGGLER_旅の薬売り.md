# SHOP/SHOP_LIFE/領地探索/領地探索_通常/SMUGGLER_旅の薬売り.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/SMUGGLER_旅の薬売り.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_SMUGGLER_EXISTS, TERRITORY_EVENT_SMUGGLER_DECISION, TERRITORY_EVENT_SMUGGLER; UI/print
