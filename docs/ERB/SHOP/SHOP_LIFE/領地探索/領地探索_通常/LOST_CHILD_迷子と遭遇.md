# SHOP/SHOP_LIFE/領地探索/領地探索_通常/LOST_CHILD_迷子と遭遇.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/LOST_CHILD_迷子と遭遇.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_LOST_CHILD_EXISTS, TERRITORY_EVENT_LOST_CHILD_DECISION, TERRITORY_EVENT_LOST_CHILD; UI/print
...
IF RAND:2
	...
	IF 対象 == MASTER && IS_COUNTRY(CFLAG:MASTER:所属)
		CALL COLOR_PRINTL("この話が仲間に広がり、好感度が100上がった", カラー_注意)
...
CALL FUCK(対象, "欲望, 奉仕, 性交, 性技, キス, 口淫, Ｖ, Ｖ性交", "キス喪失, 処女喪失, 膣内射精, 口内射精", GET_SPERM_ID("子供"), @"子供の\@RAND:2 ? ペニス # 唇\@", "子供", "", "和姦")
PRINTFORML 
