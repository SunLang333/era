# SHOP/SHOP_LIFE/領地探索/領地探索_通常/STRAY_DOG_捨て犬.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/STRAY_DOG_捨て犬.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_STRAY_DOG_EXISTS, TERRITORY_EVENT_STRAY_DOG_DECISION, TERRITORY_EVENT_STRAY_DOG; UI/print
