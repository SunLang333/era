# SHOP/SHOP_LIFE/領地探索/領地探索_通常/MOUNTAIN_HUT_山小屋.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/MOUNTAIN_HUT_山小屋.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_MOUNTAIN_HUT_EXISTS, TERRITORY_EVENT_MOUNTAIN_HUT_DECISION, TERRITORY_EVENT_MOUNTAIN_HUT; UI/print
