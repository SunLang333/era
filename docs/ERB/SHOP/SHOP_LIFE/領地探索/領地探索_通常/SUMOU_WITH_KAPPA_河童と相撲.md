# SHOP/SHOP_LIFE/領地探索/領地探索_通常/SUMOU_WITH_KAPPA_河童と相撲.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/SUMOU_WITH_KAPPA_河童と相撲.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_SUMOU_WITH_KAPPA_EXISTS, TERRITORY_EVENT_SUMOU_WITH_KAPPA_DECISION, TERRITORY_EVENT_SUMOU_WITH_KAPPA; UI/print
