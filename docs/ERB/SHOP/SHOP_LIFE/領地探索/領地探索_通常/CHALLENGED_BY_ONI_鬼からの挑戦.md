# SHOP/SHOP_LIFE/領地探索/領地探索_通常/CHALLENGED_BY_ONI_鬼からの挑戦.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/CHALLENGED_BY_ONI_鬼からの挑戦.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_CHALLENGED_BY_ONI_EXISTS, TERRITORY_EVENT_CHALLENGED_BY_ONI_DECISION, TERRITORY_EVENT_CHALLENGED_BY_ONI; UI/print
