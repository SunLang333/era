# SHOP/SHOP_LIFE/領地探索/領地探索_通常/COOK_MASHROOM_きのこ料理.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/COOK_MASHROOM_きのこ料理.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_COOK_MASHROOM_EXISTS, TERRITORY_EVENT_COOK_MASHROOM_DECISION, TERRITORY_EVENT_COOK_MASHROOM; UI/print
