# SHOP/SHOP_LIFE/領地探索/領地探索_通常/INJURED_GIRL_怪我をした少女.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/INJURED_GIRL_怪我をした少女.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_INJURED_GIRL_EXISTS, TERRITORY_EVENT_INJURED_GIRL_DECISION, TERRITORY_EVENT_INJURED_GIRL; UI/print
...
PRINTL
CALL ASK_MULTI("村へ運んでやる", "金目の物を奪って放置する", "助ける見返りを求める")
