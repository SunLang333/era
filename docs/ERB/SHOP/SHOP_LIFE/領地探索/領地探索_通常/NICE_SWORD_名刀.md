# SHOP/SHOP_LIFE/領地探索/領地探索_通常/NICE_SWORD_名刀.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/NICE_SWORD_名刀.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_NICE_SWORD_EXISTS, TERRITORY_EVENT_NICE_SWORD_DECISION, TERRITORY_EVENT_NICE_SWORD; UI/print
...
SELECTCASE RESULT
	...
	CASE 2
		...
		CALL FUCK(対象, "欲望, 性技, 奉仕, 口淫, 売春", "キス喪失, CFLAG減少", 0, "店主のペニス", "", "", "売春")
	...
	CASE 3
		...
		CALL FUCK(対象, "欲望, 奉仕, 精愛, 性技, 性交, Ｃ, Ｖ, Ｂ, Ｍ, キス, 口淫, Ｖ性交, 売春", "処女喪失, 膣内射精, キス喪失, 口内射精, CFLAG減少", GET_SPERM_ID("店主"), @"店主の\@RAND:2 ? ペニス # 唇\@", "店主", "", "売春")
		PRINTFORML 
		PRINTFORML 店主は満足し、刀を譲ってくれた
		CALL PRINT_ADD_EXP(対象, "武闘経験値", SPECIAL_TRAIN_CALC_EFFECT(対象, GETNUM(ABL, "武闘")) / 2)
ENDSELECT
