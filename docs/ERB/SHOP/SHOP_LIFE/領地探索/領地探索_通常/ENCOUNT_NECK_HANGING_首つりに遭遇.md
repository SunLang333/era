# SHOP/SHOP_LIFE/領地探索/領地探索_通常/ENCOUNT_NECK_HANGING_首つりに遭遇.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/ENCOUNT_NECK_HANGING_首つりに遭遇.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_ENCOUNT_NECK_HANGING_EXISTS, TERRITORY_EVENT_ENCOUNT_NECK_HANGING_DECISION, TERRITORY_EVENT_ENCOUNT_NECK_HANGING; UI/print
