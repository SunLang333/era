# SHOP/SHOP_LIFE/領地探索/領地探索_通常/NOPPERABOU_のっぺらぼう.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/NOPPERABOU_のっぺらぼう.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_NOPPERABOU_EXISTS, TERRITORY_EVENT_NOPPERABOU_DECISION, TERRITORY_EVENT_NOPPERABOU; UI/print
