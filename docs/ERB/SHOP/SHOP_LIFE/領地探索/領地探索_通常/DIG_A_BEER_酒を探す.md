# SHOP/SHOP_LIFE/領地探索/領地探索_通常/DIG_A_BEER_酒を探す.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/DIG_A_BEER_酒を探す.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_DIG_A_BEER_EXISTS, TERRITORY_EVENT_DIG_A_BEER_DECISION, TERRITORY_EVENT_DIG_A_BEER; UI/print
...
ELSE
	...
	ITEM:果実酒 += 3
	CALL COLOR_PRINTW("果実酒を3個手に入れた", カラー_注意)
ENDIF
