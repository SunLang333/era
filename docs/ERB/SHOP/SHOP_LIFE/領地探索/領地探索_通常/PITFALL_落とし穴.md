# SHOP/SHOP_LIFE/領地探索/領地探索_通常/PITFALL_落とし穴.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/PITFALL_落とし穴.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_PITFALL_EXISTS, TERRITORY_EVENT_PITFALL_DECISION, TERRITORY_EVENT_PITFALL; UI/print
...
SELECTCASE RESULT
	...
	CASE 2
		...
		CALL FUCK(対象, "欲望, Ｃ, 奉仕, 精愛, 性技, 口淫", "キス喪失, CFLAG減少", 0, "行きずりの男のペニス")
	CASE 3
		PRINTFORML 自力で脱出することにした
		PRINTFORMW ……結局夜までかかってしまった
		CALL ADD_COOLTIME(対象, 1)
