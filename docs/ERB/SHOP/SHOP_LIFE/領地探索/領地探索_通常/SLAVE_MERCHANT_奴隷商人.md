# SHOP/SHOP_LIFE/領地探索/領地探索_通常/SLAVE_MERCHANT_奴隷商人.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/SLAVE_MERCHANT_奴隷商人.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_SLAVE_MERCHANT_EXISTS, TERRITORY_EVENT_SLAVE_MERCHANT_DECISION, TERRITORY_EVENT_SLAVE_MERCHANT; UI/print
