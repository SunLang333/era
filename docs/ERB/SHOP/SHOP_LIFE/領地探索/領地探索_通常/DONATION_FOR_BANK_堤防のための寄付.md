# SHOP/SHOP_LIFE/領地探索/領地探索_通常/DONATION_FOR_BANK_堤防のための寄付.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/DONATION_FOR_BANK_堤防のための寄付.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_DONATION_FOR_BANK_EXISTS, TERRITORY_EVENT_DONATION_FOR_BANK_DECISION, TERRITORY_EVENT_DONATION_FOR_BANK; UI/print
