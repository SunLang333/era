# SHOP/SHOP_LIFE/領地探索/領地探索_通常/ARM_WRESLING_腕相撲.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/ARM_WRESLING_腕相撲.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_ARM_WRESLING_EXISTS, TERRITORY_EVENT_ARM_WRESLING_DECISION, TERRITORY_EVENT_ARM_WRESLING; UI/print
