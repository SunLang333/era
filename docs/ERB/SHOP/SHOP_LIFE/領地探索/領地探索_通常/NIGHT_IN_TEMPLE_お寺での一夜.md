# SHOP/SHOP_LIFE/領地探索/領地探索_通常/NIGHT_IN_TEMPLE_お寺での一夜.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/NIGHT_IN_TEMPLE_お寺での一夜.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_NIGHT_IN_TEMPLE_EXISTS, TERRITORY_EVENT_NIGHT_IN_TEMPLE_DECISION, TERRITORY_EVENT_NIGHT_IN_TEMPLE; UI/print
