# SHOP/SHOP_LIFE/領地探索/領地探索_通常/GOBLIN_THIEF_盗みを働く小鬼.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/GOBLIN_THIEF_盗みを働く小鬼.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_GOBLIN_THIEF_EXISTS, TERRITORY_EVENT_GOBLIN_THIEF_DECISION, TERRITORY_EVENT_GOBLIN_THIEF; UI/print
