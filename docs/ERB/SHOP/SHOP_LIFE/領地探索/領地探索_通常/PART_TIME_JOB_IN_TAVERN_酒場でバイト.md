# SHOP/SHOP_LIFE/領地探索/領地探索_通常/PART_TIME_JOB_IN_TAVERN_酒場でバイト.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/PART_TIME_JOB_IN_TAVERN_酒場でバイト.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_PART_TIME_JOB_IN_TAVERN_EXISTS, TERRITORY_EVENT_PART_TIME_JOB_IN_TAVERN_DECISION, TERRITORY_EVENT_PART_TIME_JOB_IN_TAVERN; UI/print
