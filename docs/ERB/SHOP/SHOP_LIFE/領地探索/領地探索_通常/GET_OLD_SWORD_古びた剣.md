# SHOP/SHOP_LIFE/領地探索/領地探索_通常/GET_OLD_SWORD_古びた剣.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/GET_OLD_SWORD_古びた剣.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_GET_OLD_SWORD_EXISTS, TERRITORY_EVENT_GET_OLD_SWORD_DECISION, TERRITORY_EVENT_GET_OLD_SWORD; UI/print
