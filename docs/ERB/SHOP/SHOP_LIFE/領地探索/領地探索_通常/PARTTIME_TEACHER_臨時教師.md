# SHOP/SHOP_LIFE/領地探索/領地探索_通常/PARTTIME_TEACHER_臨時教師.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/PARTTIME_TEACHER_臨時教師.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_PARTTIME_TEACHER_EXISTS, TERRITORY_EVENT_PARTTIME_TEACHER_DECISION, TERRITORY_EVENT_PARTTIME_TEACHER; UI/print
