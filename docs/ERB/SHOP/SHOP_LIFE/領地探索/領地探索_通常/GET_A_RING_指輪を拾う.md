# SHOP/SHOP_LIFE/領地探索/領地探索_通常/GET_A_RING_指輪を拾う.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/GET_A_RING_指輪を拾う.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_GET_A_RING_EXISTS, TERRITORY_EVENT_GET_A_RING_DECISION, TERRITORY_EVENT_GET_A_RING; UI/print
