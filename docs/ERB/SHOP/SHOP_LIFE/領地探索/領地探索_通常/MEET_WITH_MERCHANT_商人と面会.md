# SHOP/SHOP_LIFE/領地探索/領地探索_通常/MEET_WITH_MERCHANT_商人と面会.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/MEET_WITH_MERCHANT_商人と面会.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_MEET_WITH_MERCHANT_EXISTS, TERRITORY_EVENT_MEET_WITH_MERCHANT_DECISION, TERRITORY_EVENT_MEET_WITH_MERCHANT; UI/print
...
SELECTCASE RESULT
	...
	CASE 3
		...
		CALL FUCK(対象, "欲望, 奉仕, 精愛, 性技, 性交, Ｃ, Ｖ, Ｂ, Ｍ, キス, 口淫, Ｖ性交", "処女喪失, 膣内射精, キス喪失, 口内射精, CFLAG減少", GET_SPERM_ID("商人"), @"商人の\@RAND:2 ? ペニス # 唇\@", "商人", "", "和姦")
		PRINTFORML
