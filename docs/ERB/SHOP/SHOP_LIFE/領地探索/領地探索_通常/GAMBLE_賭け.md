# SHOP/SHOP_LIFE/領地探索/領地探索_通常/GAMBLE_賭け.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/領地探索/領地探索_通常/GAMBLE_賭け.ERB`

类型: .ERB

自动摘要: functions: TERRITORY_EVENT_GAMBLE_EXISTS, TERRITORY_EVENT_GAMBLE_DECISION, TERRITORY_EVENT_GAMBLE; UI/print
