# SHOP/SHOP_LIFE/SHOP_LIFE32_説得させる.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/SHOP_LIFE32_説得させる.ERB`

类型: .ERB

自动摘要: functions: SHOP_LIFE_NAME32, SHOP_LIFE_CHECK32, SHOP_LIFE_CHECKCHARA32, SHOP_LIFE_CHECKCHARA_SUB32, CHECK_SELECTABLE1012, CHECK_SELECTABLE_SETTOKU, SHOP_LIFE_EVENTBUY32, SHOP_LIFE_LIST1_BUTTON32, SHOP_LIFE_LIST2_BUTTON32, SHOP_LIFE_BUTTON_ADD_TOP32, SHOP_LIFE_BUTTON_ADD_BOTTOM32, SHOP_LIFE_EVENTBUY_SHOW32, SHOP_LIFE_EVENTBUY_SUB32, SHOP_LIFE_USERSHOP32, SHOP_LIFE_USERSHOP_SUB32, SHOP_LIFE_SETTOKU_SELECT_BEST_MEMBER, SHOP_LIFE_SETTOKU, DO_SETTOKU, SETTOKU_REL_EFFECT, CALC_SETTOKU_EFFECT; assigns RESULTS; UI/print
...
ENDIF
PRINTPLAIN   
CALL COLOR_PRINT("忠誠は所属勢力の君主への忠誠、誘惑はこちらへの気持ちの傾きを表す", カラー_注釈)
CALL COLUMN_RIGHT_PRINTL
CALL COLUMN_RIGHT_LINE
CALL COLUMN_RIGHT_PRINTL
...
PRINTFORM  
PRINTBUTTON "[自動選択]", 2
CALL COLOR_PRINT("(対象を選択してから押すとより正確)", カラー_注釈)
CALL COLUMN_RIGHT_PRINTL
CALL COLUMN_RIGHT_LINE
CALL COLUMN_RIGHT_PRINTL
