# SHOP/SHOP_LIFE/SHOP_LIFE64_推しメン.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE/SHOP_LIFE64_推しメン.ERB`

类型: .ERB

自动摘要: functions: SHOP_LIFE_NAME64, SHOP_LIFE_CHECK64, SHOP_LIFE_CHECKCHARA64, SHOP_LIFE_EVENTBUY64, SHOP_LIFE_EVENTBUY_SHOW64, SHOP_LIFE_USERSHOP64, PRINTBUTTON_FAVORITE, FAVORITE_CAN_CHOOSE; assigns RESULTS; UI/print
...
CALL COLOR_PRINT("  1回限り", カラー_選択中)
CALL COLUMN_RIGHT_PRINTL
CALL COLUMN_RIGHT_LINE
CALL COLUMN_RIGHT_PRINTL

CALL COLOR_PRINT(" 能力値を再振りできます  ", カラー_注釈)
CALL COLOR_PRINT("一回限り", カラー_選択中)
CALL COLOR_PRINT("で", カラー_注釈)
CALL COLOR_PRINT("一人", カラー_選択中)
CALL COLOR_PRINT("しか選べないので注意してください", カラー_注釈)
CALL COLUMN_RIGHT_PRINTL
CALL COLUMN_RIGHT_LINE
CALL COLUMN_RIGHT_PRINTL
...
ELSEIF RESULT == 0
	...
	SIF ポイント > 0
		CALL COLOR_PRINTL("ポイントが残ってますよ？　残しててもマジで何もいいことないですよ？", カラー_注意)
