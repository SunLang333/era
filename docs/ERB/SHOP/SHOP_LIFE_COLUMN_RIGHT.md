# SHOP/SHOP_LIFE_COLUMN_RIGHT.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE_COLUMN_RIGHT.ERB`

类型: .ERB

自动摘要: functions: COLUMN_RIGHT_CLEAR, COLUMN_RIGHT_PRINTL, COLUMN_RIGHT_TITLE, COLUMN_RIGHT_LINE, NUM_FORMAT; assigns RESULTS; UI/print
