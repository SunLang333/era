# SHOP/SHOP_LIFE.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE.ERB`

类型: .ERB

自动摘要: functions: START_COLUMN, SHOW_SHOP_LIFE, EVENTBUY_LIFE, USERSHOP_LIFE, USERSHOP_LIFE_CHARA1, USERSHOP_LIFE_CHARA2, START_TRAIN_COMMON, TRAIN_TARGET_SETTING, CALC_SHOP_TIME
