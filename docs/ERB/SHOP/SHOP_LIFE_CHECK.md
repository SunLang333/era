# SHOP/SHOP_LIFE_CHECK.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE_CHECK.ERB`

类型: .ERB

自动摘要: functions: CHECK_CHECKCHARA_SAVE, CHECK91, SHOP_LIFE_CHECKCHARA_NEYA, SHOP_LIFE_CHECKCHARA_NOURYOKU, SHOP_LIFE_CHECKCHARA_SUB_NAITSUU; assigns RESULTS
