# SHOP/SHOP_SLG_COLUMN_LEFT.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_SLG_COLUMN_LEFT.ERB`

类型: .ERB

自动摘要: functions: COLUMN_LEFT_CATEGORY_NAME_SLG, COLUMN_LEFT_PRINTBUTTON_SLG, COLUMN_LEFT_MENULINE_SAVE_SLG, COLUMN_LEFT_MENU_SHOW_SLG; assigns RESULTS; UI/print
