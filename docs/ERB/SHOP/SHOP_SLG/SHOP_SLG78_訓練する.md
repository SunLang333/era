# SHOP/SHOP_SLG/SHOP_SLG78_訓練する.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_SLG/SHOP_SLG78_訓練する.ERB`

类型: .ERB

自动摘要: functions: SHOP_SLG_NAME78, SHOP_SLG_CHECK78, SHOP_SLG_EVENTBUY78, SLG_TRAIN; assigns RESULTS; UI/print
