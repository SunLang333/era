# SHOP/SHOP_SLG/SHOP_SLG41_外交3_要求_人質.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_SLG/SHOP_SLG41_外交3_要求_人質.ERB`

类型: .ERB

自动摘要: functions: DIPLOMACY_REQUEST_HOSTAGE, SELECT_CHARA_LIST_SHOW_LOGIC_REQUEST_PRISONER; UI/print
...
PRINTFORMW %ANAME(MASTER)%は%ANAME(LOCAL:5)%に対して、人質をよこせと要求した
...
CALL SINGLE_DRAWLINE
PRINTL このキャラを我が国の捕虜として連れて行きますか？
CALL ASK_YN()
IF RESULT == 1
