# SHOP/SHOP_SLG/SHOP_SLG41_外交2_友好_経済力譲渡.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_SLG/SHOP_SLG41_外交2_友好_経済力譲渡.ERB`

类型: .ERB

自动摘要: functions: DIPLOMACY_GIVE_ECONOMY; UI/print
...
PRINTFORML %ANAME(LOCAL:4), LOCAL:20%の経済力:{LOCAL:6 / 100, LOCAL:21}
PRINTFORML %ANAME(LOCAL:5), LOCAL:20%の経済力:{LOCAL:7 / 100, LOCAL:21}
...
PRINTFORMW %ANAME(MASTER)%は%ANAME(LOCAL:5)%に経済力{LOCAL:2}を譲り渡した
