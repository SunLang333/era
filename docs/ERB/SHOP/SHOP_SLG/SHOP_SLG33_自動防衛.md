# SHOP/SHOP_SLG/SHOP_SLG33_自動防衛.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_SLG/SHOP_SLG33_自動防衛.ERB`

类型: .ERB

自动摘要: functions: SHOP_SLG_NAME33, SHOP_SLG_CHECK33, SHOP_SLG_EVENTBUY33, AUTOSET_GUARD; assigns RESULTS; UI/print
...
PRINTFORML 未割り当ての兵力を自動で各都市に振り分けます
PRINTFORML なお、敵の都市と一切隣接していない場合、このコマンドは何もしません
PRINTFORML よろしいですか？
