# SHOP/SHOP_SLG/SHOP_SLG74_クーデター.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_SLG/SHOP_SLG74_クーデター.ERB`

类型: .ERB

自动摘要: functions: SHOP_SLG_NAME74, SHOP_SLG_CHECK74, SHOP_SLG_EVENTBUY74, PLAYER_COUP; assigns RESULTS; UI/print
