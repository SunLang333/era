# SHOP/SHOP_SLG/SHOP_SLG41_外交3_要求_部下を調教.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_SLG/SHOP_SLG41_外交3_要求_部下を調教.ERB`

类型: .ERB

自动摘要: functions: DIPLOMACY_REQUEST_TRAIN_BUKA, SELECT_CHARA_LIST_SHOW_LOGIC_TRAIN_BUKA; UI/print
