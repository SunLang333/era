# SHOP/SHOP_SLG/SHOP_SLG41_外交2_友好_兵譲渡.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_SLG/SHOP_SLG41_外交2_友好_兵譲渡.ERB`

类型: .ERB

自动摘要: functions: DIPLOMACY_GIVE_SOLDIER; UI/print
...
PRINTFORMW %ANAME(MASTER)%は%ANAME(LOCAL:5)%に兵{LOCAL:2}を譲り渡した
