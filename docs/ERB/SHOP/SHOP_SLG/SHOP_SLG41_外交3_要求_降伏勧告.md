# SHOP/SHOP_SLG/SHOP_SLG41_外交3_要求_降伏勧告.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_SLG/SHOP_SLG41_外交3_要求_降伏勧告.ERB`

类型: .ERB

自动摘要: functions: DIPLOMACY_SURRENDER, DIPLOMACY_SURRENDER_SET_TREATMENT, SELECT_CHARA_LIST_SHOW_LOGIC_SURRENDER_SET_TREATMENT, SELECT_CHARA_LIST_SELECT_LOGIC_SURRENDER_SET_TREATMENT; UI/print
