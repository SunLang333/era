# SHOP/SHOP_SLG/SHOP_SLG32_防衛解除.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_SLG/SHOP_SLG32_防衛解除.ERB`

类型: .ERB

自动摘要: functions: SHOP_SLG_NAME32, SHOP_SLG_CHECK32, SHOP_SLG_EVENTBUY32, MINIMIZE_GUARD, SINGLE_MINIMIZE; assigns RESULTS; UI/print
