# SHOP/SHOP_SLG/SHOP_SLG62_徴兵解雇.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_SLG/SHOP_SLG62_徴兵解雇.ERB`

类型: .ERB

自动摘要: functions: SHOP_SLG_NAME62, SHOP_SLG_CHECK62, SHOP_SLG_EVENTBUY62, SHOP_SLG_NEXT_LINE_ADD62, SHOP_SLG_NEXT_LINE_ADD_TEXT62, SLG_EXTRA_DRAFT, SLG_EXTRA_DRAFT_CALC_RATE; assigns RESULTS; UI/print
