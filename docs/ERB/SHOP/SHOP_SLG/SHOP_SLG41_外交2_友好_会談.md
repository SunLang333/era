# SHOP/SHOP_SLG/SHOP_SLG41_外交2_友好_会談.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_SLG/SHOP_SLG41_外交2_友好_会談.ERB`

类型: .ERB

自动摘要: functions: DIPLOMACY_TALK, CALC_SEND_MONEY_EFFECT, SEND_MONEY; UI/print
