# SHOP/SHOP_SLG/SHOP_SLG73_独立.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_SLG/SHOP_SLG73_独立.ERB`

类型: .ERB

自动摘要: functions: SHOP_SLG_NAME73, SHOP_SLG_CHECK73, SHOP_SLG_EVENTBUY73, PLAYER_INDEPENDENCE, SELECT_CHARA_LIST_SHOW_LOGIC_PLAYER_INDEPENDENCE; assigns RESULTS; UI/print
