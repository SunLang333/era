# SHOP/SHOP_SLG/SHOP_SLG65_特別訓練.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_SLG/SHOP_SLG65_特別訓練.ERB`

类型: .ERB

自动摘要: functions: SHOP_SLG_NAME65, SHOP_SLG_NEXT_LINE_ADD65, SHOP_SLG_NEXT_LINE_ADD_TEXT65, SHOP_SLG_CHECK65, SHOP_SLG_EVENTBUY65, SLG_SPECIAL_TRAIN, CALC_SPECIAL_TRAIN_PRICE, SPECIAL_TRAIN_IS_BARGAIN, SPECIAL_TRAIN_CALC_EFFECT; assigns RESULTS; UI/print
...
SIF SPECIAL_TRAIN_IS_BARGAIN()
	CALL COLOR_PRINTL("ただいま大幅割引中！", カラー_注意)
PRINTFORML 誰を訓練しますか？
PRINTFORML 現在の金:%NUM_FORMAT(MONEY)%
CALL SINGLE_DRAWLINE
