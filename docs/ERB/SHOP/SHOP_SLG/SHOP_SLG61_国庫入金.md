# SHOP/SHOP_SLG/SHOP_SLG61_国庫入金.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_SLG/SHOP_SLG61_国庫入金.ERB`

类型: .ERB

自动摘要: functions: SHOP_SLG_NAME61, SHOP_SLG_CHECK61, SHOP_SLG_EVENTBUY61, SHOP_SLG_NEXT_LINE_ADD61, SHOP_SLG_NEXT_LINE_ADD_TEXT61, SLG_TREASURY_DEPOSIT; assigns RESULTS; UI/print
...
PRINTFORM %"レート:" + NUM_FORMAT(GET_SUM_ECONOMY(CFLAG:MASTER:所属) / 100000 + 1), 12%
