# SHOP/SHOP_LIFE_COLUMN_LEFT.ERB — 自动生成文档

源文件: `ERB/SHOP/SHOP_LIFE_COLUMN_LEFT.ERB`

类型: .ERB

自动摘要: functions: COLUMN_LEFT_CATEGORY_NAME, COLUMN_LEFT_CATEGORY_NAME_SHOW, COLUMN_LEFT_PRINTBUTTON, COLUMN_LEFT_MENULINE_SAVE, COLUMN_LEFT_MENU_SHOW; assigns RESULTS; UI/print
...
;セーブするほどではないが一時的に保存して@COLUMN_LEFT_MENU_SHOWで使用するので
