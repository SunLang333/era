# SLG/CONFIG_DATA_EDIT_SLG.ERB — 自动生成文档

源文件: `ERB/SLG/CONFIG_DATA_EDIT_SLG.ERB`

类型: .ERB

自动摘要: functions: CONFIG_DATA_EDIT_SLG, SHOW_CITY_INFO_EDIT, EDIT_SET_ECONOMY, EDIT_SET_GUARD_RATE; UI/print
