# SLG/STATS/STATS.ERB — 自动生成文档

源文件: `ERB/SLG/STATS/STATS.ERB`

类型: .ERB

自动摘要: functions: STATS_OUTPUT_RAW, STATS_OUTPUT, STATS_SAVE, STATS_SAVE_PREPROCESS, STATS_ENLIST_BOSS_ID, STATS_TIME_PLUS, TREATY_OUTPUT; UI/print
