# SLG/SLG_RANDOM_RISE.ERB — 自动生成文档

源文件: `ERB/SLG/SLG_RANDOM_RISE.ERB`

类型: .ERB

自动摘要: functions: SELECT_CHARA_RANDOM_BIAS_SLG_RANDOM_RISE, SLG_RANDOM_RISE, CALC_RISE_RATE; UI/print
