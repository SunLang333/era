...
自动摘要: functions: RESET_CITY_COLOR, SET_CITY_COLOR_COUNTRY, SET_CITY_COLOR_UNIT, SET_CITY_COLOR_RELATION, DRAWCITY_BUTTON, GET_CITY_NUM, GET_CITYNAME_BUTTON, GET_CITYNAME, GET_CITYNUMBER, GET_RELAYNAME, REGISTER_ROUTE, SET_CITY_TYPE, SET_MAP_ROUTE, MAPSETUP, MAP_INIT, DRAWMAP; UI/print
