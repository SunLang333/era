# SLG/SLG_RANDOM_INDEPENDENCE.ERB — 自动生成文档

源文件: `ERB/SLG/SLG_RANDOM_INDEPENDENCE.ERB`

类型: .ERB

自动摘要: functions: SELECT_CHARA_RANDOM_BIAS_SLG_RANDOM_INDEPENDENCE, SLG_RANDOM_INDEPENDENCE, CAN_RANDOM_INDEPENDENCE, CALC_INDEPENDENCE_RATE
