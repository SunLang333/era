# SLG/AI_TRAIN.ERB — 自动生成文档

源文件: `ERB/SLG/AI_TRAIN.ERB`

类型: .ERB

自动摘要: functions: SLG_AI_TRAIN, AI_TRAIN_CREATE_PLAN
...
FOR LOCAL, 0, AI_TRAIN_MAX_TARGET
	...
	SIF FIND_PASSIVE_SKILL(対象, "超成長力")
		上昇量 ++

	SIF FIND_PASSIVE_SKILL(対象, "努力家")
		上昇量 ++
