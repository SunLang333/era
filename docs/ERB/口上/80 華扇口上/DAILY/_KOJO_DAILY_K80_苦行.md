# 口上/80 華扇口上/DAILY/_KOJO_DAILY_K80_苦行.ERB — 自动生成文档

源文件: `ERB/口上/80 華扇口上/DAILY/_KOJO_DAILY_K80_苦行.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K80_PENANCE_RATE, KOJO_DAILY_K80_PENANCE_DECISION, KOJO_DAILY_K80_PENANCE_GENRE, KOJO_DAILY_K80_PENANCE; UI/print
...
SELECTCASE IFRAND("0, 1, 2, 3", 1, "4", ABL:対象:欲望 > 3 && HAS_PENIS(MASTER))
	...
	CASE 4
		...
		CALL FUCK(対象, "Ｃ, Ｂ, Ｖ, Ｍ, 欲望, 奉仕, 性技, 性交, 精愛. Ｖ性交", "処女喪失, キス喪失, 膣内射精", GET_ID(MASTER), @"%ANAME(MASTER)%のペニス", ANAME(MASTER), "", "和姦")
		CALL FUCK(MASTER, "Ｃ, 欲望, 性技, 性交, 射精, Ｖ挿入", "童貞喪失", GET_SPERM_ID("不明"), "", "", @"%ANAME(対象)%の膣", "和姦")
ENDSELECT
