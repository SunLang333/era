# 口上/71 ナズーリン口上/DAILY/_KOJO_DAILY_K71_人恋しいダウザー.ERB — 自动生成文档

源文件: `ERB/口上/71 ナズーリン口上/DAILY/_KOJO_DAILY_K71_人恋しいダウザー.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K71_FEEL_LONELY_RATE, KOJO_DAILY_K71_FEEL_LONELY_DECISION, KOJO_DAILY_K71_FEEL_LONELY_GENRE, KOJO_DAILY_K71_FEEL_LONELY; UI/print
...
ELSE
	PRINTFORMW %PRONOUN(対象)%は小さな手で%ANAME(MASTER)%の胸を撫でてきた……
	PRINTFORMW 「君に触れていると、何だか安心するな」
	PRINTFORMW 「ふふ……ああ、驚かせてしまったかな？」
ENDIF
