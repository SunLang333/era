# 口上/13 橙口上/DAILY/_KOJO_DAILY_K13_考え事.ERB — 自动生成文档

源文件: `ERB/口上/13 橙口上/DAILY/_KOJO_DAILY_K13_考え事.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K13_THINKING_RATE, KOJO_DAILY_K13_THINKING_DECISION, KOJO_DAILY_K13_THINKING_GENRE, KOJO_DAILY_K13_THINKING; UI/print
...
SELECTCASE RESULT
	...
	CASE 1
		...
		CALL COLOR_PRINTL(@"%ANAME(対象)%の武闘が3上昇した", カラー_注意)
		ABL:対象:武闘 += 3
	CASE 2
