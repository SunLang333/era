# 口上/150 紫苑口上/DAILY/_KOJO_DAILY_K150_乞食？.ERB — 自动生成文档

源文件: `ERB/口上/150 紫苑口上/DAILY/_KOJO_DAILY_K150_乞食？.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K150_BEGGER_RATE, KOJO_DAILY_K150_BEGGER_DECISION, KOJO_DAILY_K150_BEGGER_GENRE, KOJO_DAILY_K150_BEGGER; UI/print
...
PRINTFORML 
CALL ASK_MULTI_JUDGE("仲間になって", 1, "何か教えて", 1, "ヤらせて！", HAS_PENIS(MASTER), "いらない", 1)
...
SELECTCASE RESULT
	...
	CASE 1
		...
		CALL COLOR_PRINTW(@"%ANAME(MASTER)%の知略が3上がった", カラー_注意)
		ABL:MASTER:知略 += 3
	CASE 2
		PRINTFORML 「え、ええ？」
