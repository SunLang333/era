# 口上/150 紫苑口上/DAILY/_KOJO_DAILY_K150_最凶最悪の極貧不幸神.ERB — 自动生成文档

源文件: `ERB/口上/150 紫苑口上/DAILY/_KOJO_DAILY_K150_最凶最悪の極貧不幸神.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K150_EXTREME_MISFORTUNE_RATE, KOJO_DAILY_K150_EXTREME_MISFORTUNE_DECISION, KOJO_DAILY_K150_EXTREME_MISFORTUNE_GENRE, KOJO_DAILY_K150_EXTREME_MISFORTUNE; UI/print
...
CALL SKILL_LEARN_BY_NAME(対象, スキル_ジャンル_TROOP, NO:対象, "最凶最悪の極貧不幸神")
SIF RESULT
