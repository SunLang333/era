# 口上/79 はたて口上/DAILY/_KOJO_DAILY_K79_期待の新星.ERB — 自动生成文档

源文件: `ERB/口上/79 はたて口上/DAILY/_KOJO_DAILY_K79_期待の新星.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K79_RISING_STAR_RATE, KOJO_DAILY_K79_RISING_STAR_DECISION, KOJO_DAILY_K79_RISING_STAR_GENRE, KOJO_DAILY_K79_RISING_STAR; UI/print
...
PRINTFORML 簡単に信用してしまうのもどうかと思うが、この%ANAME(対象)%という少女からは毒気が感じられない
...
IF RESULT == 0
	...
	PRINTFORMW 悪意はないだろう
	PRINTFORMW そう判断した%ANAME(MASTER)%は、しばらく%ANAME(対象)%の取材に付き合ってやった……
ELSE
