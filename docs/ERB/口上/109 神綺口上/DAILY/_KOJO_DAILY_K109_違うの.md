# 口上/109 神綺口上/DAILY/_KOJO_DAILY_K109_違うの.ERB — 自动生成文档

源文件: `ERB/口上/109 神綺口上/DAILY/_KOJO_DAILY_K109_違うの.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K109_EXCUSE_RATE, KOJO_DAILY_K109_EXCUSE_DECISION, KOJO_DAILY_K109_EXCUSE_GENRE, KOJO_DAILY_K109_EXCUSE; UI/print
...
ELSE
	CALL FUCK(MASTER, "欲望, 奉仕, 性技, Ｃ, Ｂ, Ｍ, 口淫, レズ", "キス喪失", 0, @"%ANAME(対象)%の\@RAND:2 ?唇#秘貝\@", "", "", "乱交")
	CALL FUCK(対象, "欲望, 奉仕, 性技, Ｃ, Ｂ, Ｍ, 口淫, レズ", "キス喪失", 0, @"%ANAME(MASTER)%の\@RAND:2 ?唇#秘貝\@", "", "", "乱交")
	CALL FUCK(アリス, "欲望, 奉仕, 性技, Ｃ, Ｂ, Ｍ, 口淫, レズ", "キス喪失", 0, @"%ANAME(MASTER)%の\@RAND:2 ?唇#秘貝\@", "", "", "乱交")
ENDIF
