# 口上/01 霊夢口上/DAILY/KOJO_DAILY_K1_素敵な賽銭箱.ERB — 自动生成文档

源文件: `ERB/口上/01 霊夢口上/DAILY/KOJO_DAILY_K1_素敵な賽銭箱.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K1_LOVELY_SAISENBAKO_RATE, KOJO_DAILY_K1_LOVELY_SAISENBAKO_DECISION, KOJO_DAILY_K1_LOVELY_SAISENBAKO_GENRE, KOJO_DAILY_K1_LOVELY_SAISENBAKO; UI/print
...
ELSE
	...
	IF RAND:1000 < LIMIT(賽銭, 200, 800)
		...
		IF RAND:2
			CALL COLOR_PRINTW("ちょっとした御利益があったようだ……", カラー_注意)
			CALL PRINT_ADD_EXP(MASTER, EXPNAME:御利益種類, 御利益量, 1)
			CALL TRAIN_AUTO_ABLUP(MASTER)
		ELSE
			CALL COLOR_PRINTW(@"ちょっとした御利益があったようだ……%ANAME(対象)%に", カラー_注意)
