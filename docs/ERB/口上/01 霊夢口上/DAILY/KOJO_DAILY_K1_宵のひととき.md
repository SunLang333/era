# 口上/01 霊夢口上/DAILY/KOJO_DAILY_K1_宵のひととき.ERB — 自动生成文档

源文件: `ERB/口上/01 霊夢口上/DAILY/KOJO_DAILY_K1_宵のひととき.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K1_DRUNK_RATE, KOJO_DAILY_K1_DRUNK_DECISION, KOJO_DAILY_K1_DRUNK_GENRE, KOJO_DAILY_K1_DRUNK; UI/print
