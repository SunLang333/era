# 口上/01 霊夢口上/DAILY/KOJO_DAILY_K1_すけべ巫女.ERB — 自动生成文档

源文件: `ERB/口上/01 霊夢口上/DAILY/KOJO_DAILY_K1_すけべ巫女.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K1_NAUGHTY_MAIDEN_RATE, KOJO_DAILY_K1_NAUGHTY_MAIDEN_DECISION, KOJO_DAILY_K1_NAUGHTY_MAIDEN_GENRE, KOJO_DAILY_K1_NAUGHTY_MAIDEN; UI/print
