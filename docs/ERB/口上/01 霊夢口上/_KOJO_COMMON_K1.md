# 口上/01 霊夢口上/_KOJO_COMMON_K1.ERB — 自动生成文档

源文件: `ERB/口上/01 霊夢口上/_KOJO_COMMON_K1.ERB`

类型: .ERB

自动摘要: functions: KOJO_EXIST_K1, KOJO_TRAIN_START_K1, KOJO_TRAIN_END_K1, KOJO_COM_BEFORE_TARGET_K1, KOJO_COM_BEFORE_PLAYER_K1, KOJO_COM_TARGET_K1, KOJO_COM_PLAYER_K1, KOJO_COM_AFTER_K1, KOJO_SINGLE_ENDING_K1, KOJO_DEAD_ENDING_K1; UI/print
