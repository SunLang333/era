# 口上/01 霊夢口上/KOJO_B_K1.ERB — 自动生成文档

源文件: `ERB/口上/01 霊夢口上/KOJO_B_K1.ERB`

类型: .ERB

自动摘要: functions: KOJO_TRAIN_START_B_K1, KOJO_TRAIN_END_B_K1, KOJO_COM_BEFORE_TARGET_B_K1, KOJO_COM_BEFORE_PLAYER_B_K1, KOJO_COM_B_K1, KOJO_COM_TARGET_B_K1, KOJO_COM_PLAYER_B_K1, KOJO_COM_AFTER_B_K1; UI/print
