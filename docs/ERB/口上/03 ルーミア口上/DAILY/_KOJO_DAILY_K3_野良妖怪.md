# 口上/03 ルーミア口上/DAILY/_KOJO_DAILY_K3_野良妖怪.ERB — 自动生成文档

源文件: `ERB/口上/03 ルーミア口上/DAILY/_KOJO_DAILY_K3_野良妖怪.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K3_STRAY_YOUKAI_RATE, KOJO_DAILY_K3_STRAY_YOUKAI_DECISION, KOJO_DAILY_K3_STRAY_YOUKAI_GENRE, KOJO_DAILY_K3_STRAY_YOUKAI; UI/print
...
CALL ASK_MULTI_JUDGE("力が欲しい", 1, "技を教えて", GET_EMPTY_SKILL_SLOT(MASTER, スキル_ジャンル_TROOP) != -1, "金は無いと言っていたな……", 0, "仲間になって", 1, "いらない", 1)
...
SELECTCASE RESULT
	...
	CASE 1
		...
		CALL SKILL_LEARN_BY_NAME(MASTER, スキル_ジャンル_TROOP, NO:対象, "ダークサイドオブザムーン")
		CALL COLOR_PRINTW(@"%ANAME(MASTER)%はスキル「ダークサイドオブザムーン」を習得した！", カラー_注意)
	CASE 2
		;死に分岐
	CASE 3
