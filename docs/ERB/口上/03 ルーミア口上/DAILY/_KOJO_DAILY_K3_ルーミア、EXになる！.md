# 口上/03 ルーミア口上/DAILY/_KOJO_DAILY_K3_ルーミア、EXになる！.ERB — 自动生成文档

源文件: `ERB/口上/03 ルーミア口上/DAILY/_KOJO_DAILY_K3_ルーミア、EXになる！.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K3_EX_RUMIA_RATE, KOJO_DAILY_K3_EX_RUMIA_DECISION, KOJO_DAILY_K3_EX_RUMIA_GENRE, KOJO_DAILY_K3_EX_RUMIA; UI/print
