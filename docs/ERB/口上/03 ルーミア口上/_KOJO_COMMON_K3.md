# 口上/03 ルーミア口上/_KOJO_COMMON_K3.ERB — 自动生成文档

源文件: `ERB/口上/03 ルーミア口上/_KOJO_COMMON_K3.ERB`

类型: .ERB

自动摘要: functions: KOJO_EXIST_K3, KOJO_TRAIN_START_K3, KOJO_TRAIN_END_K3, KOJO_COM_TARGET_K3, KOJO_COM_PLAYER_K3, KOJO_COM_BEFORE_K3, KOJO_COM_AFTER_K3, KOJO_SINGLE_ENDING_K3, KOJO_DEAD_ENDING_K3; UI/print
