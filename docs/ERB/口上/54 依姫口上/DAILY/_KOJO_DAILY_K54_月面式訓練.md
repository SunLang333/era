# 口上/54 依姫口上/DAILY/_KOJO_DAILY_K54_月面式訓練.ERB — 自动生成文档

源文件: `ERB/口上/54 依姫口上/DAILY/_KOJO_DAILY_K54_月面式訓練.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K54_MOON_STYLE_TRAINING_RATE, KOJO_DAILY_K54_MOON_STYLE_TRAINING_DECISION, KOJO_DAILY_K54_MOON_STYLE_TRAINING_GENRE, KOJO_DAILY_K54_MOON_STYLE_TRAINING; UI/print
