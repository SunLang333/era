# 口上/11 フランドール口上/DAILY/_KOJO_DAILY_K11_質問.ERB — 自动生成文档

源文件: `ERB/口上/11 フランドール口上/DAILY/_KOJO_DAILY_K11_質問.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K11_QUESTION_RATE, KOJO_DAILY_K11_QUESTION_DECISION, KOJO_DAILY_K11_QUESTION_GENRE, KOJO_DAILY_K11_QUESTION; UI/print
...
PRINTFORMW 「あいつと%ANAME(MASTER)%と、どっちが強いの？」
PRINTFORML ……あいつというのは、%ANAME(レミリア)%のことだろう
...
PRINTFORMW 「……大風呂敷を広げているのかな？」
PRINTFORMW 「なら……私とどっちが強いか、弾幕ごっこしようよ」
...
IF ABL:MASTER:武闘 + ABL:MASTER:知略 / 3 < ABL:対象:武闘
	...
	PRINTFORMW 「これなら、あいつの方が強いんじゃないかな？」
	PRINTFORML ……負けてしまった
...
PRINTFORMW 「確かに、あいつよりも強いみたいだね」
PRINTFORMW 「私はあいつより強い。その私に勝つんだからそうもなるか」
PRINTFORMW 「……癪だな。もっと強くならないといけないかな」
...
CALL SKILL_LEARN_BY_NAME(対象, スキル_ジャンル_PERSONAL, NO:対象, "レーヴァテイン")
SIF RESULT
