# 口上/141 命蓮口上/DAILY/_KOJO_DAILY_K141_たずねびと.ERB — 自动生成文档

源文件: `ERB/口上/141 命蓮口上/DAILY/_KOJO_DAILY_K141_たずねびと.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K141_WHERE_IS_MY_SISTER_RATE, KOJO_DAILY_K141_WHERE_IS_MY_SISTER_DECISION, KOJO_DAILY_K141_WHERE_IS_MY_SISTER_GENRE, KOJO_DAILY_K141_WHERE_IS_MY_SISTER; UI/print
