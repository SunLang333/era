# 口上/152 潤美口上/_KOJO_COMMON_K152.ERB — 自动生成文档

源文件: `ERB/口上/152 潤美口上/_KOJO_COMMON_K152.ERB`

类型: .ERB

自动摘要: functions: KOJO_EXIST_K152, KOJO_TRAIN_START_K152, KOJO_TRAIN_END_K152, KOJO_COM_TARGET_K152, KOJO_COM_PLAYER_K152, KOJO_COM_BEFORE_K152, KOJO_COM_AFTER_K152, KOJO_SINGLE_ENDING_K152, KOJO_DEAD_ENDING_K152; UI/print
...
IF NOWEX:Ｃ絶頂 > 0
	...
	ELSE
		...
		IF NOWEX:Ｃ絶頂 > 4
			...
			SELECTCASE RAND:8
				CASE 0
					PRINTFORML 「やっ♥ふっ♥あっ♥　あ゛あっ♥あぁあ―z___ッ♥♥♥」
				CASE 1
					;PRINTFORML 
				CASE 2
...
IF NOWEX:Ｖ絶頂 > 0
	IF CFLAG:221 == 0
		...
		;恋慕
		IF TALENT:恋慕 || TALENT:服従 
			PRINTFORMW 「ふあっ♥あッあ―♥―ッッ♥♥　…♥イ…イカされちゃった…ッ♥」
		;それ以外
		ELSE
			PRINTFORMW 「んんっ～～～！っ！っ！」
		ENDIF
		...
		IF NOWEX:Ｖ絶頂 > 4
			...
			SELECTCASE RAND:10
				CASE 0
					;PRINTFORML 
				CASE 1
					PRINTFORML 「あッ、きっ♥は♥あ゛っ♥あ゛あ゛♥♥ぁあ―ッ♥♥♥♥」
				CASE 2
					;PRINTFORML 
				CASE 3
