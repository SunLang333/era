# 口上/92 わかさぎ姫口上/DAILY/_KOJO_DAILY_K92_石の魚.ERB — 自动生成文档

源文件: `ERB/口上/92 わかさぎ姫口上/DAILY/_KOJO_DAILY_K92_石の魚.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K92_LOM_RATE, KOJO_DAILY_K92_LOM_DECISION, KOJO_DAILY_K92_LOM_GENRE, KOJO_DAILY_K92_LOM; UI/print
