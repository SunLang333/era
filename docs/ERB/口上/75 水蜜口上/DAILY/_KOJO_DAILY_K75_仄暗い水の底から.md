# 口上/75 水蜜口上/DAILY/_KOJO_DAILY_K75_仄暗い水の底から.ERB — 自动生成文档

源文件: `ERB/口上/75 水蜜口上/DAILY/_KOJO_DAILY_K75_仄暗い水の底から.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K75_FROM_THE_DEEP_RATE, KOJO_DAILY_K75_FROM_THE_DEEP_DECISION, KOJO_DAILY_K75_FROM_THE_DEEP_GENRE, KOJO_DAILY_K75_FROM_THE_DEEP; UI/print
...
PRINTFORML 
CALL COLOR_PRINTW(@"%ANAME(対象)%が行方不明になりました", カラー_警告)
