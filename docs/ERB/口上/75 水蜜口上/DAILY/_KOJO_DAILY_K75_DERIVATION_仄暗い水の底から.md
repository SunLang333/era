# 口上/75 水蜜口上/DAILY/_KOJO_DAILY_K75_DERIVATION_仄暗い水の底から.ERB — 自动生成文档

源文件: `ERB/口上/75 水蜜口上/DAILY/_KOJO_DAILY_K75_DERIVATION_仄暗い水の底から.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K75_DERIVATION_FROM_THE_DEEP_DISABLE, KOJO_DAILY_K75_DERIVATION_FROM_THE_DEEP_DECISION, KOJO_DAILY_K75_DERIVATION_FROM_THE_DEEP; UI/print
...
CALL SKILL_LEARN_BY_NAME(対象, スキル_ジャンル_PERSONAL, NO:対象, "幽霊船永久停泊")
SIF RESULT
