# 口上/42 早苗口上/DAILY/_KOJO_DAILY_K42_花嫁修業.ERB — 自动生成文档

源文件: `ERB/口上/42 早苗口上/DAILY/_KOJO_DAILY_K42_花嫁修業.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K42_HANAYOME_SYUGYOU_RATE, KOJO_DAILY_K42_HANAYOME_SYUGYOU_DECISION, KOJO_DAILY_K42_HANAYOME_SYUGYOU_GENRE, KOJO_DAILY_K42_HANAYOME_SYUGYOU; UI/print
...
SELECTCASE IFRAND("0, 1, 2, 3, 4", 1, "5", RAND:2)
	CASE 0
		PRINTFORMW 「こんな時代だからね、想い人を煩わせないよう、自分の身は自分で守れるようになりな」
