# 口上/48 阿求/口上デイリー/_KOJO_DAILY_K48_取材.ERB — 自动生成文档

源文件: `ERB/口上/48 阿求/口上デイリー/_KOJO_DAILY_K48_取材.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K48_INTERVIEW_RATE, KOJO_DAILY_K48_INTERVIEW_DECISION, KOJO_DAILY_K48_INTERVIEW_GENRE, KOJO_DAILY_K48_INTERVIEW, KOJO_DAILY_K48_INTERVIEW_ALLOW_WHEN_WONDERING; UI/print
