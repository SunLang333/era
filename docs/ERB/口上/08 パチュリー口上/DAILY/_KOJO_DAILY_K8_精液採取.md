# 口上/08 パチュリー口上/DAILY/_KOJO_DAILY_K8_精液採取.ERB — 自动生成文档

源文件: `ERB/口上/08 パチュリー口上/DAILY/_KOJO_DAILY_K8_精液採取.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K8_GATHER_SPERM_RATE, KOJO_DAILY_K8_GATHER_SPERM_DECISION, KOJO_DAILY_K8_GATHER_SPERM_GENRE, KOJO_DAILY_K8_GATHER_SPERM, EVENTTRAIN_KOJO_DAILY_K8_GATHER_SPERM, EVENTEND_KOJO_DAILY_K8_GATHER_SPERM; UI/print
