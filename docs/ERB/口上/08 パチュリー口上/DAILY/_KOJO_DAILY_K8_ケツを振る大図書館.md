# 口上/08 パチュリー口上/DAILY/_KOJO_DAILY_K8_ケツを振る大図書館.ERB — 自动生成文档

源文件: `ERB/口上/08 パチュリー口上/DAILY/_KOJO_DAILY_K8_ケツを振る大図書館.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K8_HOBGOBLIN_GANGBANG_RATE, KOJO_DAILY_K8_HOBGOBLIN_GANGBANG_DECISION, KOJO_DAILY_K8_HOBGOBLIN_GANGBANG_GENRE, KOJO_DAILY_K8_HOBGOBLIN_GANGBANG; UI/print
