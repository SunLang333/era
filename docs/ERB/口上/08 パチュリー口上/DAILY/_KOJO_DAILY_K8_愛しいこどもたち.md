# 口上/08 パチュリー口上/DAILY/_KOJO_DAILY_K8_愛しいこどもたち.ERB — 自动生成文档

源文件: `ERB/口上/08 パチュリー口上/DAILY/_KOJO_DAILY_K8_愛しいこどもたち.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K8_TENTACLE_GANGBANG_RATE, KOJO_DAILY_K8_TENTACLE_GANGBANG_DECISION, KOJO_DAILY_K8_TENTACLE_GANGBANG_GENRE, KOJO_DAILY_K8_TENTACLE_GANGBANG; UI/print
...
PRINTFORML 
CALL COLOR_PRINTL(@"%ANAME(対象)%が触手に寄生された", カラー_注意)
