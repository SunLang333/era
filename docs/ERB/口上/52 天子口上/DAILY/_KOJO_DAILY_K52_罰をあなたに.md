# 口上/52 天子口上/DAILY/_KOJO_DAILY_K52_罰をあなたに.ERB — 自动生成文档

源文件: `ERB/口上/52 天子口上/DAILY/_KOJO_DAILY_K52_罰をあなたに.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K52_PUNISHMENT_FOR_YOU_RATE, KOJO_DAILY_K52_PUNISHMENT_FOR_YOU_DECISION, KOJO_DAILY_K52_PUNISHMENT_FOR_YOU_GENRE, KOJO_DAILY_K52_PUNISHMENT_FOR_YOU; UI/print
