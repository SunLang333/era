# 口上/45 サニーミルク口上/DAILY/_KOJO_DAILY_K45_いたずらに命をかけて.ERB — 自动生成文档

源文件: `ERB/口上/45 サニーミルク口上/DAILY/_KOJO_DAILY_K45_いたずらに命をかけて.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K45_TRICK_RATE, KOJO_DAILY_K45_TRICK_DECISION, KOJO_DAILY_K45_TRICK_GENRE, KOJO_DAILY_K45_TRICK; UI/print
...
IF RESULT == 0
	...
	IF IS_COUNTRY(CFLAG:対象:所属)
		CALL COLOR_PRINTW(@"三匹が所属する、%ANAME(GET_COUNTRY_BOSS(CFLAG:対象:所属))%との関係が改善されました", カラー_注意)
