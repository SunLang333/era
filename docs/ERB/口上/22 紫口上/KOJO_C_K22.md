# 口上/22 紫口上/KOJO_C_K22.ERB — 自动生成文档

源文件: `ERB/口上/22 紫口上/KOJO_C_K22.ERB`

类型: .ERB

自动摘要: functions: KOJO_TRAIN_START_C_K22, KOJO_TRAIN_END_C_K22, KOJO_COM_AFTER_C_K8; UI/print
