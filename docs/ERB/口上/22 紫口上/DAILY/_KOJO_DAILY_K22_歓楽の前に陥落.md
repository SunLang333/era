# 口上/22 紫口上/DAILY/_KOJO_DAILY_K22_歓楽の前に陥落.ERB — 自动生成文档

源文件: `ERB/口上/22 紫口上/DAILY/_KOJO_DAILY_K22_歓楽の前に陥落.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K22_FALL_RATE, KOJO_DAILY_K22_FALL_DECISION, KOJO_DAILY_K22_FALL_GENRE, KOJO_DAILY_K22_FALL; UI/print
