# 口上/22 紫口上/DAILY/_KOJO_DAILY_K22_道を外れた楽しみ.ERB — 自动生成文档

源文件: `ERB/口上/22 紫口上/DAILY/_KOJO_DAILY_K22_道を外れた楽しみ.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K22_FUN_OF_IMPOSSIBLE_RATE, KOJO_DAILY_K22_FUN_OF_IMPOSSIBLE_DECISION, KOJO_DAILY_K22_FUN_OF_IMPOSSIBLE_GENRE, KOJO_DAILY_K22_FUN_OF_IMPOSSIBLE; UI/print
...
PRINTFORML
CALL COLOR_PRINTW(@"\@ IS_MALE(MASTER) ? 女 # 男 \@のそれに、なっていた", カラー_注意)
PRINTFORML
