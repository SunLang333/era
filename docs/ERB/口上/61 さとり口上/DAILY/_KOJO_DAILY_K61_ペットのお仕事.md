# 口上/61 さとり口上/DAILY/_KOJO_DAILY_K61_ペットのお仕事.ERB — 自动生成文档

源文件: `ERB/口上/61 さとり口上/DAILY/_KOJO_DAILY_K61_ペットのお仕事.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K61_SATARI_PET_WORK_RATE, KOJO_DAILY_K61_SATARI_PET_WORK_DECISION, KOJO_DAILY_K61_SATARI_PET_WORK_GENRE, KOJO_DAILY_K61_SATARI_PET_WORK; UI/print
