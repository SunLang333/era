# 口上/61 さとり口上/DAILY/_KOJO_DAILY_K61_ペットへの誘い.ERB — 自动生成文档

源文件: `ERB/口上/61 さとり口上/DAILY/_KOJO_DAILY_K61_ペットへの誘い.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K61_INVITATION_TO_PET_RATE, KOJO_DAILY_K61_INVITATION_TO_PET_DECISION, KOJO_DAILY_K61_INVITATION_TO_PET_GENRE, KOJO_DAILY_K61_INVITATION_TO_PET; UI/print
...
IF RESULT == 0
	...
	CALL COLOR_PRINTL(@"%ANAME(対象)%の従属度が5000下がった", 0xFF0080)
	CALL COLOR_PRINTL(@"%ANAME(対象)%の支配度が10000上がった", 0x00FFFF)
ELSE
