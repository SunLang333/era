# 口上/34 幽香口上/DAILY/_KOJO_DAILY_K34_堕ちたフラワーマスター.ERB — 自动生成文档

源文件: `ERB/口上/34 幽香口上/DAILY/_KOJO_DAILY_K34_堕ちたフラワーマスター.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K34_AFTER_COMPETE_RATE, KOJO_DAILY_K34_AFTER_COMPETE_DECISION, KOJO_DAILY_K34_AFTER_COMPETE_GENRE, KOJO_DAILY_K34_AFTER_COMPETE; UI/print
