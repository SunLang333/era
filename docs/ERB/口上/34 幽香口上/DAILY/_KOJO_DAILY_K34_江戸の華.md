# 口上/34 幽香口上/DAILY/_KOJO_DAILY_K34_江戸の華.ERB — 自动生成文档

源文件: `ERB/口上/34 幽香口上/DAILY/_KOJO_DAILY_K34_江戸の華.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K34_COMPETE_RATE, KOJO_DAILY_K34_COMPETE_DECISION, KOJO_DAILY_K34_COMPETE_GENRE, KOJO_DAILY_K34_COMPETE; UI/print
...
CALL COLOR_PRINT("何をしてもいいわよ", カラー_注意, )
PRINTFORMW 」
PRINTFORM 「その代わり、私が勝ったら……そうね、
CALL COLOR_PRINT("有り金すべてをいただくわ", カラー_注意, )
PRINTFORMW 」
