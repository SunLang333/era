# 口上/69 霖之助口上/DAILY/_KOJO_DAILY_K69_マジックアイテム作成.ERB — 自动生成文档

源文件: `ERB/口上/69 霖之助口上/DAILY/_KOJO_DAILY_K69_マジックアイテム作成.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K69_MAGIC_ITEM_RATE, KOJO_DAILY_K69_MAGIC_ITEM_DECISION, KOJO_DAILY_K69_MAGIC_ITEM_GENRE, KOJO_DAILY_K69_MAGIC_ITEM; UI/print
