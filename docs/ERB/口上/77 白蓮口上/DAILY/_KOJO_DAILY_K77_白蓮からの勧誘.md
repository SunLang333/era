# 口上/77 白蓮口上/DAILY/_KOJO_DAILY_K77_白蓮からの勧誘.ERB — 自动生成文档

源文件: `ERB/口上/77 白蓮口上/DAILY/_KOJO_DAILY_K77_白蓮からの勧誘.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K77_INVITATION_FROM_BYAKUREN_RATE, KOJO_DAILY_K77_INVITATION_FROM_BYAKUREN_DECISION, KOJO_DAILY_K77_INVITATION_FROM_BYAKUREN_GENRE, KOJO_DAILY_K77_INVITATION_FROM_BYAKUREN; UI/print
