# 口上/18 ルナサ口上/DAILY/_KOJO_DAILY_K18_プリズムリバーライブ.ERB — 自动生成文档

源文件: `ERB/口上/18 ルナサ口上/DAILY/_KOJO_DAILY_K18_プリズムリバーライブ.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K18_PRISMRIVER_LIVE_RATE, KOJO_DAILY_K18_PRISMRIVER_LIVE_DECISION, KOJO_DAILY_K18_PRISMRIVER_LIVE_GENRE, KOJO_DAILY_K18_PRISMRIVER_LIVE_SETTARGET, KOJO_DAILY_K18_PRISMRIVER_LIVE; UI/print
...
PRINTFORMW プリズムリバー幻樂団が%CITY_NAME:対象都市%でライブを行ったようだ……
