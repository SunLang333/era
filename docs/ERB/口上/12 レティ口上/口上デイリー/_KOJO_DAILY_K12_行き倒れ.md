# 口上/12 レティ口上/口上デイリー/_KOJO_DAILY_K12_行き倒れ.ERB — 自动生成文档

源文件: `ERB/口上/12 レティ口上/口上デイリー/_KOJO_DAILY_K12_行き倒れ.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K12_FALL_ON_THE_STREET_RATE, KOJO_DAILY_K12_FALL_ON_THE_STREET_DECISION, KOJO_DAILY_K12_FALL_ON_THE_STREET_GENRE, KOJO_DAILY_K12_FALL_ON_THE_STREET; UI/print
