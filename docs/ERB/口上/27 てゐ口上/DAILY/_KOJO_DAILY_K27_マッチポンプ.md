# 口上/27 てゐ口上/DAILY/_KOJO_DAILY_K27_マッチポンプ.ERB — 自动生成文档

源文件: `ERB/口上/27 てゐ口上/DAILY/_KOJO_DAILY_K27_マッチポンプ.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K27_LUCKY_ENDING_RATE, KOJO_DAILY_K27_LUCKY_ENDING_DECISION, KOJO_DAILY_K27_LUCKY_ENDING_GENRE, KOJO_DAILY_K27_LUCKY_ENDING; UI/print
...
PRINTFORML どうしたものか……
PRINTFORML
CALL ASK_MULTI_JUDGE("無罪放免", 1, "引っ捕らえる", GET_COUNTRY_BOSS(CFLAG:対象:所属) != 対象, "売上をよこせ", 1, "なんか教えて", 1, "犯す", HAS_PENIS(MASTER))
...
SELECTCASE RESULT
	...
	CASE 4
		...
		ELSE
			PRINTFORMW 「は？　あんた女でしょ？何言ってるんだか……ちょ！　何で脱いでんの！？」
			PRINTFORMW 「え、な……それ……」
		ENDIF
