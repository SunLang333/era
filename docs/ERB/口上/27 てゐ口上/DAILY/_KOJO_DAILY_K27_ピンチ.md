# 口上/27 てゐ口上/DAILY/_KOJO_DAILY_K27_ピンチ.ERB — 自动生成文档

源文件: `ERB/口上/27 てゐ口上/DAILY/_KOJO_DAILY_K27_ピンチ.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K27_PINCH_RATE, KOJO_DAILY_K27_PINCH_DECISION, KOJO_DAILY_K27_PINCH_GENRE, KOJO_DAILY_K27_PINCH; UI/print
...
ELSE
	PRINTFORMW 「ねぇねぇ、これだけ%ANAME(MASTER)%のものと趣味が違わない？」
	PRINTFORMW 「もしかしてこれ%ANAME(MASTER)%の下着じゃないんじゃない？」
ENDIF
