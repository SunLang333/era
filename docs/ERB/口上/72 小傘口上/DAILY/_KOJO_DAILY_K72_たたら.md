# 口上/72 小傘口上/DAILY/_KOJO_DAILY_K72_たたら.ERB — 自动生成文档

源文件: `ERB/口上/72 小傘口上/DAILY/_KOJO_DAILY_K72_たたら.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K72_SMITHING_RATE, KOJO_DAILY_K72_SMITHING_DECISION, KOJO_DAILY_K72_SMITHING_GENRE, KOJO_DAILY_K72_SMITHING; UI/print
...
CALL COLOR_PRINTW(@"%ANAME(MASTER)%の武闘が3上がった", カラー_注意)
ABL:MASTER:武闘 += 3
IF !TALENT:対象:技師
	CALL COLOR_PRINTW(@"%ANAME(対象)%は＜技師＞を得た", カラー_注意)
	TALENT:対象:技師 = 1
ENDIF
