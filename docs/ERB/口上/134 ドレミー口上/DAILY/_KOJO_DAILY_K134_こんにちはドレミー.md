# 口上/134 ドレミー口上/DAILY/_KOJO_DAILY_K134_こんにちはドレミー.ERB — 自动生成文档

源文件: `ERB/口上/134 ドレミー口上/DAILY/_KOJO_DAILY_K134_こんにちはドレミー.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K134_DOREMY_IN_DREAM_RATE, KOJO_DAILY_K134_DOREMY_IN_DREAM_DECISION, KOJO_DAILY_K134_DOREMY_IN_DREAM_GENRE, KOJO_DAILY_K134_DOREMY_IN_DREAM; UI/print
...
IF CFLAG:対象:所属 != CFLAG:MASTER:所属
	...
	PRINTFORML
	CALL COLOR_PRINTW(@"%NAME_FORMAL(対象)%の面識を得ました", カラー_注意)
	CFLAG:対象:好感度 += 200
	CFLAG:対象:面識 = 1
