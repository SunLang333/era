# 口上/05 チルノ口上/DAILY/_KOJO_DAILY_K5_蛙冷凍ごっこ.ERB — 自动生成文档

源文件: `ERB/口上/05 チルノ口上/DAILY/_KOJO_DAILY_K5_蛙冷凍ごっこ.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K5_FROZEN_RATE, KOJO_DAILY_K5_FROZEN_DECISION, KOJO_DAILY_K5_FROZEN_GENRE, KOJO_DAILY_K5_FROZEN; UI/print
...
SIF RESULT
    CALL COLOR_PRINTW(@"%ANAME(対象)%はスキル「瞬間冷凍ビーム」を習得した！", カラー_注意)
KDVAR:対象:チルノ_蛙冷凍ごっこ = 1
