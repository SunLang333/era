# 口上/94 影狼口上/DAILY/_KOJO_DAILY_K94_焼肉デート.ERB — 自动生成文档

源文件: `ERB/口上/94 影狼口上/DAILY/_KOJO_DAILY_K94_焼肉デート.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K94_KAGEROU_YAKINIKU_RATE, KOJO_DAILY_K94_KAGEROU_YAKINIKU_DECISION, KOJO_DAILY_K94_KAGEROU_YAKINIKU_GENRE, KOJO_DAILY_K94_KAGEROU_YAKINIKU; UI/print
