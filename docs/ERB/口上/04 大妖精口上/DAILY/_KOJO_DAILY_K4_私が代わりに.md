# 口上/04 大妖精口上/DAILY/_KOJO_DAILY_K4_私が代わりに.ERB — 自动生成文档

源文件: `ERB/口上/04 大妖精口上/DAILY/_KOJO_DAILY_K4_私が代わりに.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K4_INSTEAD_OF_HER_RATE, KOJO_DAILY_K4_INSTEAD_OF_HER_DECISION, KOJO_DAILY_K4_INSTEAD_OF_HER_GENRE, KOJO_DAILY_K4_INSTEAD_OF_HER; UI/print
...
CALL SKILL_LEARN_BY_NAME(対象, スキル_ジャンル_PERSONAL, NO:対象, "すごい応援")
SIF RESULT
