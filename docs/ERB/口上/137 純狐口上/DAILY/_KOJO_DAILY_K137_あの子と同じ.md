# 口上/137 純狐口上/DAILY/_KOJO_DAILY_K137_あの子と同じ.ERB — 自动生成文档

源文件: `ERB/口上/137 純狐口上/DAILY/_KOJO_DAILY_K137_あの子と同じ.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K137_ENVY_RATE, KOJO_DAILY_K137_ENVY_DECISION, KOJO_DAILY_K137_ENVY_GENRE, KOJO_DAILY_K137_ENVY; UI/print
...
IF !TALENT:対象:合意
	CALL COLOR_PRINT(@"%ANAME(対象)%の合意を得ました", カラー_注意)
	TALENT:対象:合意 = 1
ENDIF
TALENT:対象:チョロイン = 1
