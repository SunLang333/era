# 口上/24 リグル口上/DAILY/_KOJO_DAILY_K24_蟲の知らせ.ERB — 自动生成文档

源文件: `ERB/口上/24 リグル口上/DAILY/_KOJO_DAILY_K24_蟲の知らせ.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K24_NOTICE_FROM_INSECT_RATE, KOJO_DAILY_K24_NOTICE_FROM_INSECT_DECISION, KOJO_DAILY_K24_NOTICE_FROM_INSECT_GENRE, KOJO_DAILY_K24_NOTICE_FROM_INSECT; UI/print
...
#DIM 対象
IF ABL:対象:欲望 >= 3 && IS_FALLEN(対象) && HAS_PENIS(MASTER)
