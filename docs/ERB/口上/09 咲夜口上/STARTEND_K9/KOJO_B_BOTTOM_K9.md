# 口上/09 咲夜口上/STARTEND_K9/KOJO_B_BOTTOM_K9.ERB — 自动生成文档

源文件: `ERB/口上/09 咲夜口上/STARTEND_K9/KOJO_B_BOTTOM_K9.ERB`

类型: .ERB

自动摘要: functions: KOJO_TRAIN_START_B_K9, KOJO_TRAIN_END_B_K9; UI/print
