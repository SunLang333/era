# 口上/09 咲夜口上/DAILY/_KOJO_DAILY_K9_親しい呼び方.ERB — 自动生成文档

源文件: `ERB/口上/09 咲夜口上/DAILY/_KOJO_DAILY_K9_親しい呼び方.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K9_ASK_MASTER_NAME_RATE, KOJO_DAILY_K9_ASK_MASTER_NAME_DECISION, KOJO_DAILY_K9_ASK_MASTER_NAME_GENRE, KOJO_DAILY_K9_ASK_MASTER_NAME; assigns RESULTS; UI/print
