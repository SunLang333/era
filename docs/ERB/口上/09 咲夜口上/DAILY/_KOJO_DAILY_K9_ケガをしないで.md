# 口上/09 咲夜口上/DAILY/_KOJO_DAILY_K9_ケガをしないで.ERB — 自动生成文档

源文件: `ERB/口上/09 咲夜口上/DAILY/_KOJO_DAILY_K9_ケガをしないで.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K9_DO_NOT_HURT_YOURSELF_RATE, KOJO_DAILY_K9_DO_NOT_HURT_YOURSELF_DECISION, KOJO_DAILY_K9_DO_NOT_HURT_YOURSELF_GENRE, KOJO_DAILY_K9_DO_NOT_HURT_YOURSELF; UI/print
