# 口上/10 レミリア口上/STARTEND_K10/KOJO_B_BOTTOM_K10.ERB — 自动生成文档

源文件: `ERB/口上/10 レミリア口上/STARTEND_K10/KOJO_B_BOTTOM_K10.ERB`

类型: .ERB

自动摘要: functions: KOJO_TRAIN_START_B_K10, KOJO_TRAIN_END_B_K10; UI/print
