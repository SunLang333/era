# 口上/10 レミリア口上/DAILY/_KOJO_DAILY_K10_スレイヴ・オブ・ミッドナイト.ERB — 自动生成文档

源文件: `ERB/口上/10 レミリア口上/DAILY/_KOJO_DAILY_K10_スレイヴ・オブ・ミッドナイト.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K10_HOBGOBLIN_SLAVE_RATE, KOJO_DAILY_K10_HOBGOBLIN_SLAVE_DECISION, KOJO_DAILY_K10_HOBGOBLIN_SLAVE_GENRE, KOJO_DAILY_K10_HOBGOBLIN_SLAVE; UI/print
...
PRINTFORML 熱心な奉仕のご褒美に、彼は足で%ANAME(対象)%の秘部を弄繰り回す
...
PRINTL
CALL COLOR_PRINTW(@"%ANAME(対象)%の『%GET_TATTOO_NAME(RESULT)%』に、%TATTOO:対象:RESULT%と入れ墨が彫られた……", カラー_ピンク)
CALL COLOR_PRINTW(@"%ANAME(対象)%が心の底から、ホフゴブリンの奴隷となった", カラー_ピンク)
PRINTFORML 
