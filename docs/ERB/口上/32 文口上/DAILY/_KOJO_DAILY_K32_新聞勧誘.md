# 口上/32 文口上/DAILY/_KOJO_DAILY_K32_新聞勧誘.ERB — 自动生成文档

源文件: `ERB/口上/32 文口上/DAILY/_KOJO_DAILY_K32_新聞勧誘.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K32_INVITATION_FROM_AYA_RATE, KOJO_DAILY_K32_INVITATION_FROM_AYA_DECISION, KOJO_DAILY_K32_INVITATION_FROM_AYA_GENRE, KOJO_DAILY_K32_INVITATION_FROM_AYA; UI/print
