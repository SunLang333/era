# 口上/95 弁々口上/DAILY/_KOJO_DAILY_K95_シマイガッキ.ERB — 自动生成文档

源文件: `ERB/口上/95 弁々口上/DAILY/_KOJO_DAILY_K95_シマイガッキ.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K95_SHIMAI_DON_RATE, KOJO_DAILY_K95_SHIMAI_DON_DECISION, KOJO_DAILY_K95_SHIMAI_DON_GENRE, KOJO_DAILY_K95_SHIMAI_DON; UI/print
