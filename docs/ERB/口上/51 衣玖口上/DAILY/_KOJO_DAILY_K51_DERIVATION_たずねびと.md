# 口上/51 衣玖口上/DAILY/_KOJO_DAILY_K51_DERIVATION_たずねびと.ERB — 自动生成文档

源文件: `ERB/口上/51 衣玖口上/DAILY/_KOJO_DAILY_K51_DERIVATION_たずねびと.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K51_DERIVATION_WHERE_IS_TENSHI_DISABLE, KOJO_DAILY_K51_DERIVATION_WHERE_IS_TENSHI_DECISION, KOJO_DAILY_K51_DERIVATION_WHERE_IS_TENSHI_SETTARGET, KOJO_DAILY_K51_DERIVATION_WHERE_IS_TENSHI; UI/print
