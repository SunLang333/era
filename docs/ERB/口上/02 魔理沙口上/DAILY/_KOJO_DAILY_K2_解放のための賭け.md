# 口上/02 魔理沙口上/DAILY/_KOJO_DAILY_K2_解放のための賭け.ERB — 自动生成文档

源文件: `ERB/口上/02 魔理沙口上/DAILY/_KOJO_DAILY_K2_解放のための賭け.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K2_GAMBLE_FOR_FREEDOM_RATE, KOJO_DAILY_K2_GAMBLE_FOR_FREEDOM_DECISION, KOJO_DAILY_K2_GAMBLE_FOR_FREEDOM_GENRE, KOJO_DAILY_K2_GAMBLE_FOR_FREEDOM_SETTARGET, KOJO_DAILY_K2_GAMBLE_FOR_FREEDOM; UI/print
