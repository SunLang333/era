# 口上/81 響子口上/DAILY/_KOJO_DAILY_K81_朝の挨拶.ERB — 自动生成文档

源文件: `ERB/口上/81 響子口上/DAILY/_KOJO_DAILY_K81_朝の挨拶.ERB`

类型: .ERB

自动摘要: functions: KOJO_DAILY_K81_GOOD_MORNING_RATE, KOJO_DAILY_K81_GOOD_MORNING_DECISION, KOJO_DAILY_K81_GOOD_MORNING_GENRE, KOJO_DAILY_K81_GOOD_MORNING; UI/print
