# TRAIN/PREGNANT/CREAMPIE_HISTORY.ERB — 自动生成文档

源文件: `ERB/TRAIN/PREGNANT/CREAMPIE_HISTORY.ERB`

类型: .ERB

自动摘要: functions: UPDATE_CREAMPIE_HISTORY, GET_FATHER_CANDIDATE_FROM_CREAMPIE_HISTORY, CLEAR_CREAMPIE_HISTORY
