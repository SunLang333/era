# TRAIN/COMF/COMF60_ローター.ERB — 自动生成文档

源文件: `ERB/TRAIN/COMF/COMF60_ローター.ERB`

类型: .ERB

自动摘要: functions: COM_NAME60, COM_ABLE60, COM60, COM_ORDER_PLAYER60, COM_TEXT_BEFORE60, COM_TEXT_LAST60, COM_AVAILABLE_WHEN60, COM_PREFERENCE_PLAYER_60, COM_PREFERENCE_TARGET_60; assigns RESULTS; UI/print
