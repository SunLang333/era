# TRAIN/COMF/COMF55_順番に挿入.ERB — 自动生成文档

源文件: `ERB/TRAIN/COMF/COMF55_順番に挿入.ERB`

类型: .ERB

自动摘要: functions: COM_NAME55, COM_ABLE55, COM55, COM_EQUIP55, COM_IS_EQUIP55, COM_ORDER_PLAYER55, EQUIP_MESSAGE55, COM_TEXT_BEFORE_EQUIP55, COM_TEXT_RELEASE_EQUIP55, COM_TEXT_BEFORE55, COM_AVAILABLE_WHEN55, COM_PREFERENCE_PLAYER_55, COM_PREFERENCE_TARGET_55, COM_STACK_SPERM_MPLY_TO_MTAR_55; assigns RESULTS; UI/print
...
FOR LOCAL:0, 0, MTAR_NUM
	...
	CALL DOUTEI_COMMON(MPLY:0, @"%ANAME(MTAR:(LOCAL:0))%たちの膣", "乱交")
