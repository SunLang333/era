# TRAIN/COMF/COMF53_Ａ逆駅弁.ERB — 自动生成文档

源文件: `ERB/TRAIN/COMF/COMF53_Ａ逆駅弁.ERB`

类型: .ERB

自动摘要: functions: COM_NAME53, COM_ABLE53, COM53, COM_IS_EQUIP53, COM_EQUIP53, EQUIP_MESSAGE53, COM_TEXT_BEFORE_EQUIP53, COM_TEXT_RELEASE_EQUIP53, COM_ORDER_PLAYER53, COM_TEXT_BEFORE53, COM_TEXT_LAST53, COM_AVAILABLE_WHEN53, COM_PREFERENCE_PLAYER_53, COM_PREFERENCE_TARGET_53, COM_STACK_SPERM_MPLY_TO_MTAR_53; assigns RESULTS; UI/print
...
;-------------------------------------------------
@COM_NAME53
IF IS_INSERT_SINGLE(MTAR:0, "Ｖ") && GROUPMATCH(GET_SEX_POSITION_SINGLE(MTAR:0, "Ｖ"), 9, 30) && IS_INSERT_MUTUAL(MPLY:0, MTAR:0) != 1
	LOCALS:0 = 二穴Ａ背面駅弁
ELSE
	LOCALS:0 = Ａ背面駅弁
ENDIF
...
SIF MTAR_NUM <= 0 || MTAR_NUM > 1
	RETURN 0
SIF IS_INSERT_SINGLE(MTAR:0, "Ｖ") && !GROUPMATCH(GET_SEX_POSITION_SINGLE(MTAR:0, "Ｖ"), 9, 30)
	RETURN 0
SIF IS_A_HOLD(MTAR:0)
	RETURN 0
SIF !CAN_FUCK(MPLY:0, MTAR:0, 53)
	RETURN 0
RETURN 1
