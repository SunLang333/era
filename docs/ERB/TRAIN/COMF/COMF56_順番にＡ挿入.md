# TRAIN/COMF/COMF56_順番にＡ挿入.ERB — 自动生成文档

源文件: `ERB/TRAIN/COMF/COMF56_順番にＡ挿入.ERB`

类型: .ERB

自动摘要: functions: COM_NAME56, COM_ABLE56, COM56, COM_EQUIP56, COM_IS_EQUIP56, COM_ORDER_PLAYER56, EQUIP_MESSAGE56, COM_TEXT_BEFORE_EQUIP56, COM_TEXT_RELEASE_EQUIP56, COM_TEXT_BEFORE56, COM_AVAILABLE_WHEN56, COM_PREFERENCE_PLAYER_56, COM_PREFERENCE_TARGET_56, COM_STACK_SPERM_MPLY_TO_MTAR_56; assigns RESULTS; UI/print
...
FOR LOCAL:0, 0, MTAR_NUM
	...
	CALL DOUTEI_COMMON(MPLY:0, @"%ANAME(MTAR:(LOCAL:0))%たちのアナル", "乱交")
