# TRAIN/COMF/COMF161_Ａ立ちバック.ERB — 自动生成文档

源文件: `ERB/TRAIN/COMF/COMF161_Ａ立ちバック.ERB`

类型: .ERB

自动摘要: functions: COM_NAME161, COM_ABLE161, COM161, COM_IS_EQUIP161, COM_EQUIP161, EQUIP_MESSAGE161, COM_TEXT_BEFORE_EQUIP161, COM_TEXT_RELEASE_EQUIP161, COM_ORDER_PLAYER161, COM_TEXT_BEFORE161, COM_TEXT_LAST161, COM_AVAILABLE_WHEN161, COM_PREFERENCE_PLAYER_161, COM_PREFERENCE_TARGET_161, COM_STACK_SPERM_MPLY_TO_MTAR_161; assigns RESULTS; UI/print
...
SIF IS_A_HOLD(MTAR:0)
	RETURN 0
;already fucked, unless by frontal standing
SIF IS_INSERT_SINGLE(MTAR:0, "Ｖ") && !GROUPMATCH(GET_SEX_POSITION_SINGLE(MTAR:0, "Ｖ"), 9)
	RETURN 0
SIF !CAN_FUCK(MPLY:0, MTAR:0, 161)
	RETURN 0
