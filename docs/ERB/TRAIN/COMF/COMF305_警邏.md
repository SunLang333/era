# TRAIN/COMF/COMF305_警邏.ERB — 自动生成文档

源文件: `ERB/TRAIN/COMF/COMF305_警邏.ERB`

类型: .ERB

自动摘要: functions: COM_NAME305, COM_ABLE305, COM305, COM_TEXT_BEFORE305, COM_TEXT_LAST305, COM_AVAILABLE_WHEN305; assigns RESULTS; UI/print
...
;このターンの経済成長パワー追加値
LOCAL:0 = (ABL:(MPLY:0):武闘 + ABL:(MTAR:0):武闘 + ABL:(MPLY:0):政治 + ABL:(MTAR:0):政治 + 200) * 25

;このターンの兵数増強パワー追加値
LOCAL:1 = (ABL:(MPLY:0):武闘 + ABL:(MTAR:0):武闘 + ABL:(MPLY:0):政治 + ABL:(MTAR:0):政治 + 200) * 2 / 5
