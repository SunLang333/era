# TRAIN/COMF/COMF108_セルフ挿入.ERB — 自动生成文档

源文件: `ERB/TRAIN/COMF/COMF108_セルフ挿入.ERB`

类型: .ERB

自动摘要: functions: COM_NAME108, COM_ABLE108, COM108, COM_IS_EQUIP108, COM_EQUIP108, EQUIP_MESSAGE108, COM_TEXT_BEFORE_EQUIP108, COM_TEXT_RELEASE_EQUIP108, COM_ORDER_PLAYER108, COM_TEXT_BEFORE108, COM_TEXT_LAST108, COM_AVAILABLE_WHEN108, COM_PREFERENCE_PLAYER_108, COM_PREFERENCE_TARGET_108, COM_STACK_SPERM_MPLY_TO_MPLY_108; assigns RESULTS; UI/print
...
FOR LOCAL:0, 0, MPLY_NUM
	...
	IF TALENT:(LOCAL:2):処女 == 1
		SOURCE:(LOCAL:2):快Ｖ += SENSE_SEX_TARGET((LOCAL:2), (LOCAL:2), LOCAL:3)
	ELSE
		SOURCE:(LOCAL:2):快Ｖ += SENSE_SEX_TARGET((LOCAL:2), (LOCAL:2), LOCAL:3)
	ENDIF
