# TRAIN/COMF/COMF311_蜂蜜水.ERB — 自动生成文档

源文件: `ERB/TRAIN/COMF/COMF311_蜂蜜水.ERB`

类型: .ERB

自动摘要: functions: COM_NAME311, COM_ABLE311, COM311, COM_TEXT_BEFORE311, COM_TEXT_LAST311, COM_AVAILABLE_WHEN311; assigns RESULTS; UI/print
...
;-------------------------------------------------
@COM_TEXT_BEFORE311
PRINTFORMW %ANAME(MPLY:0)%は%ANAME(MTAR:0)%に蜂蜜水をプレゼントした
IF TFLAG:18 == 1
	PRINTFORML 思いのほか喜んでもらえたようだ…
ELSEIF TFLAG:18 == -1
	PRINTFORML あまり甘いものを飲む気分ではなかったようだ…
ENDIF
