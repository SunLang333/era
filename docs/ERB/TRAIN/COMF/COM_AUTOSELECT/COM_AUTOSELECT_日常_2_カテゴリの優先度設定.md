# TRAIN/COMF/COM_AUTOSELECT/COM_AUTOSELECT_日常_2_カテゴリの優先度設定.ERB — 自动生成文档

源文件: `ERB/TRAIN/COMF/COM_AUTOSELECT/COM_AUTOSELECT_日常_2_カテゴリの優先度設定.ERB`

类型: .ERB

自动摘要: functions: COM_AUTOSELECT_N_SET_CATEGORY_PRIORITY; UI/print
...
ELSEIF CFLAG:MAIN_PLAYER:好感度 < 800
	;男同士ではない、あるいは、両刀である
	IF !IS_SAMESEX_M(MASTER, MAIN_PLAYER) || TALENT:MAIN_PLAYER:両刀
