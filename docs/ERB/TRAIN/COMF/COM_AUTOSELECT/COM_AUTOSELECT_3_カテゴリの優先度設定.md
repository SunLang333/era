# TRAIN/COMF/COM_AUTOSELECT/COM_AUTOSELECT_3_カテゴリの優先度設定.ERB — 自动生成文档

源文件: `ERB/TRAIN/COMF/COM_AUTOSELECT/COM_AUTOSELECT_3_カテゴリの優先度設定.ERB`

类型: .ERB

自动摘要: functions: COM_AUTOSELECT_SET_CATEGORY_PRIORITY; UI/print
...
;-------------------------------------------------
IF FLAG:調教モード == 調教_慰安 && !TALENT:MAIN_PLAYER:慰安モブ && !CFLAG:MAIN_PLAYER:慰安参加者
