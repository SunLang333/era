# TRAIN/COMF/COMF36_二本挿入.ERB — 自动生成文档

源文件: `ERB/TRAIN/COMF/COMF36_二本挿入.ERB`

类型: .ERB

自动摘要: functions: COM_NAME36, COM_ABLE36, COM36, COM_EQUIP36, COM_IS_EQUIP36, EQUIP_MESSAGE36, COM_TEXT_BEFORE_EQUIP36, COM_TEXT_RELEASE_EQUIP36, COM_ORDER_PLAYER36, COM_TEXT_BEFORE36, COM_AVAILABLE_WHEN36, COM_PREFERENCE_PLAYER_36, COM_PREFERENCE_TARGET_36, COM_STACK_SPERM_MPLY_TO_MTAR_36; assigns RESULTS; UI/print
...
SIF IS_V_HOLD(MTAR:0)
	RETURN 0
;todo shouldn't this mostly depend on TALENT:MTAR:Ｖ締まり? same with the text
