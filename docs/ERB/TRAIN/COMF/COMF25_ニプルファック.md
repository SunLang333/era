# TRAIN/COMF/COMF25_ニプルファック.ERB — 自动生成文档

源文件: `ERB/TRAIN/COMF/COMF25_ニプルファック.ERB`

类型: .ERB

自动摘要: functions: COM_NAME25, COM_ABLE25, COM25, COM_IS_EQUIP25, COM_EQUIP25, EQUIP_MESSAGE25, COM_TEXT_BEFORE_EQUIP25, COM_TEXT_RELEASE_EQUIP25, COM_ORDER_PLAYER25, COM_TEXT_BEFORE25, COM_AVAILABLE_WHEN25, COM_PREFERENCE_PLAYER_25, COM_PREFERENCE_TARGET_25, COM_STACK_SPERM_MPLY_TO_MTAR_25; assigns RESULTS; UI/print
...
RESULTS = %EQUIP_PLAYER_ANAME(ARG:0)%が%EQUIP_TARGET_ANAME(ARG:0)%にニプルファック中
