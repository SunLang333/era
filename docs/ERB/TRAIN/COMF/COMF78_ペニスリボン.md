# TRAIN/COMF/COMF78_ペニスリボン.ERB — 自动生成文档

源文件: `ERB/TRAIN/COMF/COMF78_ペニスリボン.ERB`

类型: .ERB

自动摘要: functions: COM_NAME78, COM_ABLE78, COM78, COM_IS_EQUIP78, COM_EQUIP78, EQUIP_MESSAGE78, COM_TEXT_BEFORE_EQUIP78, COM_TEXT_RELEASE_EQUIP78, COM_ORDER_PLAYER78, COM_TEXT_BEFORE78, COM_AVAILABLE_WHEN78, COM_PREFERENCE_PLAYER_78, COM_PREFERENCE_TARGET_78; assigns RESULTS; UI/print
...
RESULTS = %EQUIP_TARGET_ANAME(ARG:0)%の射精を禁止中

;-------------------------------------------------
;継続中の地の文(前文)
;-------------------------------------------------
@COM_TEXT_BEFORE_EQUIP78(ARG:0)
PRINTFORML %EQUIP_TARGET_ANAME(ARG:0)%のペニスはリボンで戒められている……

;-------------------------------------------------
;継続を解除したときの地の文
;-------------------------------------------------
@COM_TEXT_RELEASE_EQUIP78(ARG:0)
PRINTFORMW %EQUIP_TARGET_ANAME(ARG:0)%のペニスを戒めるリボンを解いた
