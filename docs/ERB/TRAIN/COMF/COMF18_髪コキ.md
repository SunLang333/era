# TRAIN/COMF/COMF18_髪コキ.ERB — 自动生成文档

源文件: `ERB/TRAIN/COMF/COMF18_髪コキ.ERB`

类型: .ERB

自动摘要: functions: COM_NAME18, COM_ABLE18, COM18, COM_IS_EQUIP18, COM_EQUIP18, EQUIP_MESSAGE18, COM_TEXT_BEFORE_EQUIP18, COM_TEXT_RELEASE_EQUIP18, COM_ORDER_PLAYER18, COM_TEXT_BEFORE18, COM_AVAILABLE_WHEN18, COM_PREFERENCE_PLAYER_18, COM_PREFERENCE_TARGET_18, COM_STACK_SPERM_MTAR_TO_MPLY_18; assigns RESULTS; UI/print
...
FOR LOCAL:0, 0, MPLY_NUM
	;ミドル以上が必要
	SIF TALENT:(MPLY:(LOCAL:0)):髪の長さ < 4
		RETURN 0
...
RESULTS = %EQUIP_PLAYER_ANAME(ARG:0)%が%EQUIP_TARGET_ANAME(ARG:0)%に髪コキ中

;-------------------------------------------------
;継続中の地の文(前文)
;-------------------------------------------------
@COM_TEXT_BEFORE_EQUIP18(ARG:0)
PRINTFORML %EQUIP_PLAYER_ANAME(ARG:0)%が%EQUIP_TARGET_ANAME(ARG:0)%のペニスに髪を絡めてシゴき上げている…
