# TRAIN/COMF/COMF84_目隠し.ERB — 自动生成文档

源文件: `ERB/TRAIN/COMF/COMF84_目隠し.ERB`

类型: .ERB

自动摘要: functions: COM_NAME84, COM_ABLE84, COM84, COM_IS_EQUIP84, COM_EQUIP84, EQUIP_MESSAGE84, COM_TEXT_BEFORE_EQUIP84, COM_TEXT_RELEASE_EQUIP84, COM_ORDER_PLAYER84, COM_TEXT_BEFORE84, COM_AVAILABLE_WHEN84, COM_PREFERENCE_PLAYER_84, COM_PREFERENCE_TARGET_84; assigns RESULTS; UI/print
...
RESULTS = %EQUIP_TARGET_ANAME(ARG:0)%に目隠し中

;-------------------------------------------------
;継続中の地の文(前文)
;-------------------------------------------------
@COM_TEXT_BEFORE_EQUIP84(ARG:0)
PRINTFORML %EQUIP_TARGET_ANAME(ARG:0)%は布で視界を塞がれている…

;-------------------------------------------------
;継続を解除したときの地の文
;-------------------------------------------------
@COM_TEXT_RELEASE_EQUIP84(ARG:0)
PRINTFORMW %EQUIP_TARGET_ANAME(ARG:0)%の目隠しを外した
...
SELECTCASE GET_COM_INITIATIVE()
	;プレイヤーに主導権
	CASE 0
		PRINTFORMW %ANAME(MPLY:0)%は%LOCALS:1%の目の周りに布を巻き付けて視界を奪っ%TARGET_STR("た", "てきた")%…
```
