# TRAIN/COMF/COMF81_スパンキング.ERB — 自动生成文档

源文件: `ERB/TRAIN/COMF/COMF81_スパンキング.ERB`

类型: .ERB

自动摘要: functions: COM_NAME81, COM_ABLE81, COM81, COM_ORDER_PLAYER81, COM_TEXT_BEFORE81, COM_TEXT_LAST81, COM_AVAILABLE_WHEN81, COM_PREFERENCE_PLAYER_81, COM_PREFERENCE_TARGET_81; assigns RESULTS; UI/print
...
FOR LOCAL:0, 0, MTAR_NUM
	...
	IF TALENT:(LOCAL:1):美尻 || GET_HIPSIZE(LOCAL:1) >= 1
