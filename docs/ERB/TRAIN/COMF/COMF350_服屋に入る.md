# TRAIN/COMF/COMF350_服屋に入る.ERB — 自动生成文档

源文件: `ERB/TRAIN/COMF/COMF350_服屋に入る.ERB`

类型: .ERB

自动摘要: functions: COM_NAME350, COM_ABLE350, COM350, COM_ORDER_PLAYER350, COM_TEXT_BEFORE350, COM_TEXT_LAST350, COM_AVAILABLE_WHEN350; assigns RESULTS; UI/print
...
PRINTFORMW %ANAME(MPLY:0)%と%ANAME(MTAR:0)%は服屋に入った…

$SELECT_LOOP

CALL SINGLE_DRAWLINE
PRINTFORML ●服の購入(所持金:{MONEY})
PRINTL   [0] チャイナ服    ( 5000)
PRINTL   [1] メイド服      (20000)
PRINTL   [2] セーラー服    (20000)
PRINTL   [3] ボンデージ    (20000)
PRINTL   [4] ゴシックドレス(40000)
PRINTL   [5] ホワイトドレス(80000)
PRINTL   [6] 和服          (40000)
CALL SINGLE_DRAWLINE
PRINTL   [9] 見るだけ
