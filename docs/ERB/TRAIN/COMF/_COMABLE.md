# TRAIN/COMF/_COMABLE.ERB — 自动生成文档

源文件: `ERB/TRAIN/COMF/_COMABLE.ERB`

类型: .ERB

自动摘要: functions: COM_ABLE_COMMON, CHECK_COM_AVAILABLE, SET_COM_KNOWLEDGE, CHECK_COM_KNOWLEDGE, QUADORUPED_ANIMAL_COMABLE_MPLY, QUADORUPED_ANIMAL_COMABLE_MTAR; UI/print; definition/data
