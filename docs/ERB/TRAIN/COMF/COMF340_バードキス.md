# TRAIN/COMF/COMF340_バードキス.ERB — 自动生成文档

源文件: `ERB/TRAIN/COMF/COMF340_バードキス.ERB`

类型: .ERB

自动摘要: functions: COM_NAME340, COM_ABLE340, COM340, COM_ORDER_PLAYER340, COM_ORDER_TARGET340, COM_TEXT_BEFORE340, COM_TEXT_LAST340, COM_AVAILABLE_WHEN340; assigns RESULTS; UI/print
...
SOURCE:(MPLY:0):快Ｍ = SENSE_HOUSHI(MTAR:0, MPLY:0, 50)
SOURCE:(MPLY:0):奉仕 = SERVE_HOUSHI(MPLY:0, 50)
...
SOURCE:(MTAR:0):快Ｍ = SENSE_HOUSHI(MPLY:0, MTAR:0, 50)
SOURCE:(MTAR:0):奉仕 = SERVE_HOUSHI(MTAR:0, 50)
