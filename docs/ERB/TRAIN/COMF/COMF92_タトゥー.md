# TRAIN/COMF/COMF92_タトゥー.ERB — 自动生成文档

源文件: `ERB/TRAIN/COMF/COMF92_タトゥー.ERB`

类型: .ERB

自动摘要: functions: COM_NAME92, COM_ABLE92, COM92, COM_ORDER_PLAYER92, COM_ORDER_TARGET92, COM_TEXT_BEFORE92, COM_AVAILABLE_WHEN92, COM_PREFERENCE_PLAYER_92, COM_PREFERENCE_TARGET_92; assigns RESULTS; UI/print
