# TRAIN/COMF/COMF38_屈曲位.ERB — 自动生成文档

源文件: `ERB/TRAIN/COMF/COMF38_屈曲位.ERB`

类型: .ERB

自动摘要: functions: COM_NAME38, COM_ABLE38, COM38, COM_IS_EQUIP38, COM_EQUIP38, EQUIP_MESSAGE38, COM_TEXT_BEFORE_EQUIP38, COM_TEXT_RELEASE_EQUIP38, COM_ORDER_PLAYER38, COM_TEXT_BEFORE38, COM_TEXT_LAST38, COM_AVAILABLE_WHEN38, COM_PREFERENCE_PLAYER_38, COM_PREFERENCE_TARGET_38, COM_STACK_SPERM_MPLY_TO_MTAR_38; assigns RESULTS; UI/print
...
;-------------------------------------------------
@COM_NAME38
IF IS_INSERT_SINGLE(MTAR:0, "Ａ") && GROUPMATCH(GET_SEX_POSITION_SINGLE(MTAR:0, "Ａ"), 6, 30) && IS_INSERT_MUTUAL(MPLY:0, MTAR:0) != 2
	LOCALS:0 = 二穴屈曲位
ELSE
	LOCALS:0 = 屈曲位
ENDIF
...
SIF IS_INSERT_SINGLE(MTAR:0, "Ａ") && !GROUPMATCH(GET_SEX_POSITION_SINGLE(MTAR:0, "Ａ"), 6, 30)
	RETURN 0
SIF !CAN_FUCK(MPLY:0, MTAR:0, 38)
	RETURN 0
RETURN 1
