# SYSTEM/SHOW_INFO/SHOW_INFO_DESIGN.ERB — 自动生成文档

源文件: `ERB/SYSTEM/SHOW_INFO/SHOW_INFO_DESIGN.ERB`

类型: .ERB

自动摘要: functions: SMALL_TITLE, SMALL_TITLE_SPACE, PRINT_GRADATIONBAR, PRINT_VERSUSBAR; UI/print
