# SYSTEM/NEWGAME.ERB — 自动生成文档

源文件: `ERB/SYSTEM/NEWGAME.ERB`

类型: .ERB

自动摘要: functions: SYSTEM_TITLE, EVENTFIRST, INIT_COMMON, INIT_RANK, SET_ABL_MIN_MAX, INIT_NEWGAME, ADDITIONAL_CHARA_SETTING; UI/print; references CSV; definition/data
