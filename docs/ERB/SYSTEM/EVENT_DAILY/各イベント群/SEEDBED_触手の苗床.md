# SYSTEM/EVENT_DAILY/各イベント群/SEEDBED_触手の苗床.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/SEEDBED_触手の苗床.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_SEEDBED_RATE, EVENT_DAILY_SEEDBED_DECISION, EVENT_DAILY_SEEDBED_GENRE, EVENT_DAILY_SEEDBED_SETTARGET, EVENT_DAILY_SEEDBED, EVENT_DAILY_SEEDBED_ALLOW_WHEN_WANDERING; UI/print
