# SYSTEM/EVENT_DAILY/各イベント群/派生/DIPLO_AFTER_KILL_BANDIT.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/派生/DIPLO_AFTER_KILL_BANDIT.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_DERIVATION_AFTER_KILL_BANDIT_DISABLE, EVENT_DAILY_DERIVATION_AFTER_KILL_BANDIT_DECISION, EVENT_DAILY_DERIVATION_AFTER_KILL_BANDIT, EVENTTRAIN_AFTER_KILL_BANDIT_BEFORE_TRAIN, EVENTEND_AFTER_KILL_BANDIT_AFTER_TRAIN_A, EVENTEND_AFTER_KILL_BANDIT_AFTER_TRAIN_B; UI/print
