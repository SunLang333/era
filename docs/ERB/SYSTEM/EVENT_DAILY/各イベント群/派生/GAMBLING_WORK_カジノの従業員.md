# SYSTEM/EVENT_DAILY/各イベント群/派生/GAMBLING_WORK_カジノの従業員.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/派生/GAMBLING_WORK_カジノの従業員.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_DERIVATION_GAMBLING_WORK_DISABLE, EVENT_DAILY_DERIVATION_GAMBLING_WORK_DECISION, EVENT_DAILY_DERIVATION_GAMBLING_WORK_SETTARGET, EVENT_DAILY_DERIVATION_GAMBLING_WORK; UI/print
...
FOR LOCAL, 0, DAILY_TARGET_NUM
	...
	SELECTCASE RAND:18
		CASE 0
			...
			CALL FUCK(対象, "口淫, 精愛, 奉仕, 性技, 売春", "キス喪失, CFLAG減少, ", GET_SPERM_ID("不明"), @"カジノの客のペニス", "", "", "売春")
		CASE 1
			PRINTFORML %ANAME(対象)%はホールスタッフについたようだ
			PRINTFORML 途中、客に個人的な奉仕を要求された
			PRINTFORML %ANAME(対象)%は座る彼にまたがると、自らの秘部で彼のモノを咥え込む
			PRINTFORML 男が精を解き放つと、%ANAME(対象)%は背をそらしながら絶頂した……
			CALL FUCK(対象, "Ｃ, Ｂ, Ｖ, Ｖ性交, 性交, 性技, 奉仕, 精愛, 売春", "処女喪失, 膣内射精, CFLAG減少, ", GET_SPERM_ID("カジノの客"), @"カジノの客の\@RAND:2 ? ペニス # 唇\@", "カジノの客", "", "売春")
		CASE 2
			PRINTFORML %ANAME(対象)%はホールスタッフについたようだ
			...
			CALL FUCK(対象, "Ｃ, Ｂ, Ｖ, Ｍ, 奉仕, 売春", "CFLAG減少, ", GET_SPERM_ID("カジノの客"), @"カジノの客の\@RAND:2 ? ペニス # 唇\@", "カジノの客", "", "売春")
		CASE 3
			PRINTFORML %ANAME(対象)%はホールスタッフについたようだ
			...
			CALL FUCK(対象, "Ｃ, Ｂ, Ｖ, Ｖ性交, 性交, 性技, 奉仕, 精愛, 口淫, 売春", "キス喪失, 処女喪失, 口内射精, 膣内射精, CFLAG減少, ", GET_SPERM_ID("カジノの客"), @"カジノの客の\@RAND:2 ? ペニス # 唇\@", "カジノの客", "", "売春")
		CASE 4
			PRINTFORML %ANAME(対象)%はホールスタッフについたようだ
		...
		CASE 6
			...
			CALL FUCK(対象, "Ｃ, Ｂ, Ｖ, Ｖ性交, 性交, 性技, 奉仕, 精愛, 口淫, 露出, 売春", "キス喪失, 処女喪失, 口内射精, 膣内射精, CFLAG減少, ", GET_SPERM_ID("カジノの客"), @"カジノの客の\@RAND:2 ? ペニス # 唇\@", "カジノの客", "", "売春")
		CASE 7
		...
		CASE 8
			...
			CALL FUCK(対象, "Ｃ, Ｖ, Ａ, Ｂ, Ｍ, 性交, 精愛, 口淫, Ｖ性交, Ａ性交, マゾ, 輪姦, 露出, 売春", "キス喪失, 処女喪失, Ａ処女喪失, CFLAG減少, 性癖取得, 膣内射精, 腸内射精, 口内射精, ",GET_SPERM_ID("カジノの客"), @"カジノの客の\@RAND:2 ? ペニス # 唇\@", "カジノの客", "", "売春")
		CASE 9
			...
			CALL FUCK(対象, "Ｃ, Ｂ, Ｖ, Ｖ性交, 性交, 性技, 奉仕, 精愛, 獣姦, 露出, 売春", "処女喪失, 膣内射精, CFLAG減少, ", GET_SPERM_ID("豚"), "豚のペニス", "豚", "", "売春")
		CASE 10
		...
		CASE 12
			...
			CALL FUCK(対象, "Ｃ, Ｖ, Ａ, Ｂ, Ｍ, 性交, 精愛, 口淫, Ｖ性交, Ａ性交, マゾ, 輪姦, 売春", "キス喪失, 処女喪失, Ａ処女喪失, CFLAG減少, 性癖取得, 膣内射精, 腸内射精, 口内射精, ",GET_SPERM_ID("カジノの客"), @"カジノのスタッフの\@RAND:2 ? ペニス # 唇\@", "カジノのスタッフ", "", "輪姦")
		CASE 13
			...
			CALL FUCK(対象, "Ｃ, Ｂ, Ｖ, Ｖ性交, 性交, 性技, 奉仕, 精愛, 口淫, 売春", "キス喪失, 処女喪失, 口内射精, 膣内射精, CFLAG減少, ", GET_SPERM_ID("カジノの客"), @"カジノの支配人の\@RAND:2 ? ペニス # 唇\@", "カジノの支配人", "", "売春")
		CASE 14
			PRINTFORML %ANAME(対象)%は支配人に奉仕している
		...
		CASE 17
			...
			CALL FUCK(対象, "Ｃ, Ｖ, Ａ, Ｂ, Ｍ, 性交, 精愛, 口淫, Ｖ性交, Ａ性交, 苦痛快楽, 緊縛, マゾ, 輪姦, 売春", "キス喪失, 処女喪失, Ａ処女喪失, CFLAG減少, 性癖取得, 膣内射精, 腸内射精, 口内射精, ",GET_SPERM_ID("浮浪者"), @"浮浪者の\@RAND:2 ? ペニス # 唇\@", "浮浪者", "", "輪姦")
	ENDSELECT
	PRINTW
NEXT
RETURN 1
