# SYSTEM/EVENT_DAILY/各イベント群/派生/HYPNOTISM_ADDICTION_催眠傀儡の日々.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/派生/HYPNOTISM_ADDICTION_催眠傀儡の日々.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_DERIVATION_HYPNOTISM_ADDICTION_DISABLE, EVENT_DAILY_DERIVATION_HYPNOTISM_ADDICTION_DECISION, EVENT_DAILY_DERIVATION_HYPNOTISM_ADDICTION_SETTARGET, EVENT_DAILY_DERIVATION_HYPNOTISM_ADDICTION; UI/print
		...
		CASE 5 TO 8
			...
			SELECTCASE RAND:10
				...
				CASE 2
					...
					PRINTFORMW 彼が射精すると%ANAME(対象)%は膣に染み込んでくる熱に歓喜の雄たけびを上げてアクメした
				CASE 3
