# SYSTEM/EVENT_DAILY/各イベント群/派生/REPAYMENT_AFTER_通い妻とのデート.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/派生/REPAYMENT_AFTER_通い妻とのデート.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_DERIVATION_REPAYMENT_AFTER_DISABLE, EVENT_DAILY_DERIVATION_REPAYMENT_AFTER_DECISION, EVENT_DAILY_DERIVATION_REPAYMENT_AFTER; UI/print
