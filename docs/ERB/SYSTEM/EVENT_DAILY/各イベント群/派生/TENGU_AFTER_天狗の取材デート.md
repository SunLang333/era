# SYSTEM/EVENT_DAILY/各イベント群/派生/TENGU_AFTER_天狗の取材デート.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/派生/TENGU_AFTER_天狗の取材デート.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_DERIVATION_TENGU_AFTER_DISABLE, EVENT_DAILY_DERIVATION_TENGU_AFTER_DECISION, EVENT_DAILY_DERIVATION_TENGU_AFTER; UI/print
