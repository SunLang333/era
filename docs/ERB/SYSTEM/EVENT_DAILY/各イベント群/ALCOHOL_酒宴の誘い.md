# SYSTEM/EVENT_DAILY/各イベント群/ALCOHOL_酒宴の誘い.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/ALCOHOL_酒宴の誘い.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_ALCOHOL_RATE, EVENT_DAILY_ALCOHOL_DECISION, EVENT_DAILY_ALCOHOL_GENRE, EVENT_DAILY_ALCOHOL, SELECT_CHARA_LIST_SHOW_LOGIC_DAILY_ALCOHOL, SELECT_CHARA_LIST_SELECT_LOGIC_DAILY_ALCOHOL; UI/print
