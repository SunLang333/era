# SYSTEM/EVENT_DAILY/各イベント群/MEETING_WITH_ZAIYA_在野武将との面会.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/MEETING_WITH_ZAIYA_在野武将との面会.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_MEETING_WITH_ZAIYA_RATE, EVENT_DAILY_MEETING_WITH_ZAIYA_DECISION, EVENT_DAILY_MEETING_WITH_ZAIYA_GENRE, EVENT_DAILY_MEETING_WITH_ZAIYA_SETTARGET, EVENT_DAILY_MEETING_WITH_ZAIYA, EVENT_DAILY_MEETING_WITH_ZAIYA_ALLOW_WHEN_WANDERING; UI/print
