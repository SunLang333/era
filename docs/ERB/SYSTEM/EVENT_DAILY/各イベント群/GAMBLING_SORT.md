# SYSTEM/EVENT_DAILY/各イベント群/GAMBLING_SORT.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/GAMBLING_SORT.ERB`

类型: .ERB

自动摘要: functions: GAMBLING_SORT, PRINT_CASINO_SORTING_README; UI/print
