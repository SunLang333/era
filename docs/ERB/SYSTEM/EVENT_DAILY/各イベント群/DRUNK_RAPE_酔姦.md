# SYSTEM/EVENT_DAILY/各イベント群/DRUNK_RAPE_酔姦.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/DRUNK_RAPE_酔姦.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_DRUNK_RAPE_RATE, EVENT_DAILY_DRUNK_RAPE_DECISION, EVENT_DAILY_DRUNK_RAPE_SETTARGET, SELECT_CHARA_RANDOM_LOGIC_DAILY_DRUNK_RAPE, EVENT_DAILY_DRUNK_RAPE_GENRE, EVENT_DAILY_DRUNK_RAPE; UI/print
