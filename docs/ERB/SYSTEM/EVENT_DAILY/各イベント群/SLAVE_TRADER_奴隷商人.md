# SYSTEM/EVENT_DAILY/各イベント群/SLAVE_TRADER_奴隷商人.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/SLAVE_TRADER_奴隷商人.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_SLAVE_TRADER_RATE, EVENT_DAILY_SLAVE_TRADER_DECISION, EVENT_DAILY_SLAVE_TRADER_GENRE, EVENT_DAILY_SLAVE_TRADER, SLAVE_TRADER_PRICE; UI/print
