# SYSTEM/EVENT_DAILY/各イベント群/TERRITORY_SPA_TOWN_温泉旅行.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/TERRITORY_SPA_TOWN_温泉旅行.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_TERRITORY_SPA_TOWN_RATE, EVENT_DAILY_TERRITORY_SPA_TOWN_DECISION, EVENT_DAILY_TERRITORY_SPA_TOWN_GENRE, EVENT_DAILY_TERRITORY_SPA_TOWN, SELECT_CHARA_LIST_SHOW_LOGIC_DAILY_TERRITORY_SPA_TOWN, SELECT_CHARA_LIST_SELECT_LOGIC_DAILY_TERRITORY_SPA_TOWN; UI/print
...
ELSEIF IS_MALE(MASTER) || (HAS_PENIS(MASTER) && RAND:2) || (HAS_PENIS(MASTER) && TALENT:MASTER:男嫌い)
