# SYSTEM/EVENT_DAILY/各イベント群/PUBLIC_TOILET_あいつは精液便女.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/PUBLIC_TOILET_あいつは精液便女.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_PUBLIC_TOILET_RATE, EVENT_DAILY_PUBLIC_TOILET_DECISION, EVENT_DAILY_PUBLIC_TOILET_GENRE, EVENT_DAILY_PUBLIC_TOILET_SETTARGET, EVENT_DAILY_PUBLIC_TOILET, EVENT_DAILY_PUBLIC_TOILET_ALLOW_WHEN_WANDERING; UI/print
