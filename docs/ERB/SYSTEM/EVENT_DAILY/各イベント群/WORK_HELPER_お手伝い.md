# SYSTEM/EVENT_DAILY/各イベント群/WORK_HELPER_お手伝い.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/WORK_HELPER_お手伝い.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_WORK_HELPER_RATE, EVENT_DAILY_WORK_HELPER_DECISION, EVENT_DAILY_WORK_HELPER_GENRE, EVENT_DAILY_WORK_HELPER_SETTARGET, EVENT_DAILY_WORK_HELPER; UI/print
