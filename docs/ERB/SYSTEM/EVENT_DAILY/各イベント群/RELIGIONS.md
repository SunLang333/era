# SYSTEM/EVENT_DAILY/各イベント群/RELIGIONS.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/RELIGIONS.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_RELIGIONS_RATE, EVENT_DAILY_RELIGIONS_DECISION, EVENT_DAILY_RELIGIONS_GENRE, EVENT_DAILY_RELIGIONS, SELECT_CHARA_LIST_SHOW_LOGIC_RELIGIONS; UI/print
