# SYSTEM/EVENT_DAILY/各イベント群/SUCCUBUS/SUCCUBUS_DREAM_サキュバスの誘惑.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/SUCCUBUS/SUCCUBUS_DREAM_サキュバスの誘惑.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_SUCCUBUS_DREAM_RATE, EVENT_DAILY_SUCCUBUS_DREAM_DECISION, EVENT_DAILY_SUCCUBUS_DREAM_GENRE, EVENT_DAILY_SUCCUBUS_DREAM_SETTARGET, EVENT_DAILY_SUCCUBUS_DREAM; UI/print
...
ENDSELECT
CALL FUCK(対象, "欲望, 欲望, 奉仕, 性技, 性交, 精愛, Ｃ, Ｖ, Ｂ, Ｍ, Ｖ性交, キス, 口淫", "CFLAG減少", 0, "", "", "")
PRINTFORML 
