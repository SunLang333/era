# SYSTEM/EVENT_DAILY/各イベント群/SUCCUBUS/SUCCUBUS_BATTLE_サキュバスとの闘い.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/SUCCUBUS/SUCCUBUS_BATTLE_サキュバスとの闘い.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_SUCCUBUS_BATTLE_RATE, EVENT_DAILY_SUCCUBUS_BATTLE_DECISION, EVENT_DAILY_SUCCUBUS_BATTLE_GENRE, EVENT_DAILY_SUCCUBUS_BATTLE, SUCCUBUS_BATTLE_SEX; UI/print
