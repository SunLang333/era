# SYSTEM/EVENT_DAILY/各イベント群/TRAINING_TOGETHER_一緒に訓練.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/TRAINING_TOGETHER_一緒に訓練.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_TRAINING_TOGETHER_RATE, EVENT_DAILY_TRAINING_TOGETHER_DECISION, EVENT_DAILY_TRAINING_TOGETHER_SETTARGET, EVENT_DAILY_TRAINING_TOGETHER_GENRE, EVENT_DAILY_TRAINING_TOGETHER; UI/print
