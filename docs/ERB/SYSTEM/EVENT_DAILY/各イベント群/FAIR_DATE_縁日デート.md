# SYSTEM/EVENT_DAILY/各イベント群/FAIR_DATE_縁日デート.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/FAIR_DATE_縁日デート.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_FAIR_DATE_RATE, EVENT_DAILY_FAIR_DATE_DECISION, EVENT_DAILY_FAIR_DATE_SETTARGET, EVENT_DAILY_FAIR_DATE_GENRE, EVENT_DAILY_FAIR_DATE; UI/print
