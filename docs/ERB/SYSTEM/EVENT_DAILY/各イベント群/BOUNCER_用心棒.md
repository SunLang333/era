# SYSTEM/EVENT_DAILY/各イベント群/BOUNCER_用心棒.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/BOUNCER_用心棒.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_BOUNCER_RATE, EVENT_DAILY_BOUNCER_DECISION, EVENT_DAILY_BOUNCER_GENRE, EVENT_DAILY_BOUNCER; UI/print
