# SYSTEM/EVENT_DAILY/各イベント群/ABL_TRAINER.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/ABL_TRAINER.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_SABORI_TRAINER_RATE, EVENT_DAILY_SABORI_TRAINER_DECISION, EVENT_DAILY_SABORI_TRAINER_GENRE, EVENT_DAILY_SABORI_TRAINER, SELECT_CHARA_LIST_SHOW_LOGIC_SABORI_TRAINER, SELECT_CHARA_LIST_SELECT_LOGIC_SABORI_TRAINER; UI/print
