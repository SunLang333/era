# SYSTEM/EVENT_DAILY/各イベント群/DAILY_MISC_小型イベント.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/DAILY_MISC_小型イベント.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_DAILY_MISC_RATE, EVENT_DAILY_DAILY_MISC_DECISION, EVENT_DAILY_DAILY_MISC_GENRE, EVENT_DAILY_DAILY_MISC; UI/print
