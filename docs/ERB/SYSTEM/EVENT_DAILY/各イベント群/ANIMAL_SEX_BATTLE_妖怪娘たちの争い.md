# SYSTEM/EVENT_DAILY/各イベント群/ANIMAL_SEX_BATTLE_妖怪娘たちの争い.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/ANIMAL_SEX_BATTLE_妖怪娘たちの争い.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_ANIMAL_SEX_BATTLE_RATE, EVENT_DAILY_ANIMAL_SEX_BATTLE_DECISION, EVENT_DAILY_ANIMAL_SEX_BATTLE_GENRE, EVENT_DAILY_ANIMAL_SEX_BATTLE; UI/print
...
ENDSELECT
CALL FUCK(MASTER, "性技, 性交, Ｃ, 射精, Ｖ挿入", "童貞喪失", 0, "", "", @"%種族間抗争_種類:対象%の娘の膣", "和姦")
PRINTFORMW 
