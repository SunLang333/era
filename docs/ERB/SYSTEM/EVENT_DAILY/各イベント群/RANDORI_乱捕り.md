# SYSTEM/EVENT_DAILY/各イベント群/RANDORI_乱捕り.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/RANDORI_乱捕り.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_RANDORI_RATE, EVENT_DAILY_RANDORI_DECISION, EVENT_DAILY_RANDORI_GENRE, EVENT_DAILY_RANDORI; UI/print
