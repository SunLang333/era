# SYSTEM/EVENT_DAILY/各イベント群/SAIMINSLAVE_催眠調教師.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/SAIMINSLAVE_催眠調教師.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_SAIMINSLAVE_RATE, EVENT_DAILY_SAIMINSLAVE_DECISION, EVENT_DAILY_SAIMINSLAVE_GENRE, EVENT_DAILY_SAIMINSLAVE, SELECT_CHARA_LIST_SHOW_LOGIC_SAIMINSLAVE; UI/print
