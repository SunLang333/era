# SYSTEM/EVENT_DAILY/各イベント群/ASSASSIN_GIRL_暗殺者.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/ASSASSIN_GIRL_暗殺者.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_ASSASSIN_GIRL_RATE, EVENT_DAILY_ASSASSIN_GIRL_DECISION, EVENT_DAILY_ASSASSIN_GIRL_GENRE, EVENT_DAILY_ASSASSIN_GIRL; UI/print
