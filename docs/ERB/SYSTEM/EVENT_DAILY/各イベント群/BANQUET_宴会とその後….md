# SYSTEM/EVENT_DAILY/各イベント群/BANQUET_宴会とその後….ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/BANQUET_宴会とその後….ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_BANQUET_RATE, EVENT_DAILY_BANQUET_DECISION, EVENT_DAILY_BANQUET_GENRE, EVENT_DAILY_BANQUET, SELECT_CHARA_LIST_SHOW_LOGIC_BANQUET; UI/print
