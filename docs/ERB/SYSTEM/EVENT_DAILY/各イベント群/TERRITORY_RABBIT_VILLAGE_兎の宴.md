# SYSTEM/EVENT_DAILY/各イベント群/TERRITORY_RABBIT_VILLAGE_兎の宴.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/TERRITORY_RABBIT_VILLAGE_兎の宴.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_TERRITORY_RABBIT_VILLAGE_RATE, EVENT_DAILY_TERRITORY_RABBIT_VILLAGE_DECISION, EVENT_DAILY_TERRITORY_RABBIT_VILLAGE_GENRE, EVENT_DAILY_TERRITORY_RABBIT_VILLAGE; UI/print
