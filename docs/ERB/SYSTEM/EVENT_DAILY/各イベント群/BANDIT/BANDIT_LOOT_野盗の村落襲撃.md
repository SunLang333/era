# SYSTEM/EVENT_DAILY/各イベント群/BANDIT/BANDIT_LOOT_野盗の村落襲撃.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/BANDIT/BANDIT_LOOT_野盗の村落襲撃.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_BANDIT_LOOT_RATE, EVENT_DAILY_BANDIT_LOOT_DECISION, EVENT_DAILY_BANDIT_LOOT_GENRE, EVENT_DAILY_BANDIT_LOOT, BANDIT_LOOT_RAPE; UI/print
