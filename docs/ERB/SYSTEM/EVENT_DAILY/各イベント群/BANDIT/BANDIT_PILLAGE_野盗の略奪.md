# SYSTEM/EVENT_DAILY/各イベント群/BANDIT/BANDIT_PILLAGE_野盗の略奪.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/BANDIT/BANDIT_PILLAGE_野盗の略奪.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_BANDIT_PILLAGE_RATE, EVENT_DAILY_BANDIT_PILLAGE_DECISION, EVENT_DAILY_BANDIT_PILLAGE_GENRE, EVENT_DAILY_BANDIT_PILLAGE, SELECT_CHARA_LIST_SHOW_LOGIC_BANDIT_PILLAGE, SELECT_CHARA_LIST_SELECT_LOGIC_BANDIT_PILLAGE; UI/print
