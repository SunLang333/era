# SYSTEM/EVENT_DAILY/各イベント群/BANDIT/BANDIT_REQUEST_野盗からの性奴隷要求.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/BANDIT/BANDIT_REQUEST_野盗からの性奴隷要求.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_BANDIT_REQUEST_RATE, EVENT_DAILY_BANDIT_REQUEST_DECISION, EVENT_DAILY_BANDIT_REQUEST_GENRE, EVENT_DAILY_BANDIT_REQUEST_SETTARGET, EVENT_DAILY_BANDIT_REQUEST; UI/print
