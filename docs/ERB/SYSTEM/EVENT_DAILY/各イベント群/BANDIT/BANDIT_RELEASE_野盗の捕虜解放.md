# SYSTEM/EVENT_DAILY/各イベント群/BANDIT/BANDIT_RELEASE_野盗の捕虜解放.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/BANDIT/BANDIT_RELEASE_野盗の捕虜解放.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_BANDIT_RELEASE_RATE, EVENT_DAILY_BANDIT_RELEASE_DECISION, EVENT_DAILY_BANDIT_RELEASE_SETTARGET, EVENT_DAILY_BANDIT_RELEASE_GENRE, EVENT_DAILY_BANDIT_RELEASE, BANDIT_RELEASE_MSG; UI/print
