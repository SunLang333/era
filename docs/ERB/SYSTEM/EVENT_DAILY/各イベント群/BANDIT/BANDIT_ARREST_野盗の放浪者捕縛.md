# SYSTEM/EVENT_DAILY/各イベント群/BANDIT/BANDIT_ARREST_野盗の放浪者捕縛.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/BANDIT/BANDIT_ARREST_野盗の放浪者捕縛.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_BANDIT_ARREST_RATE, EVENT_DAILY_BANDIT_ARREST_DECISION, EVENT_DAILY_BANDIT_ARREST_SETTARGET, EVENT_DAILY_BANDIT_ARREST_GENRE, EVENT_DAILY_BANDIT_ARREST; UI/print
...
PRINTFORML
PRINTFORM
CALL COLOR_PRINT(@"%ANAME(対象)%は野盗の性奴隷として捕らえられました", カラー_警告)
PRINTFORMW
CALL CAPTURE(対象, 野盗)
RETURN 1
