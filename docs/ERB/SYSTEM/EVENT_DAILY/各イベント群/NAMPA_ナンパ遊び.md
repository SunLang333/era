# SYSTEM/EVENT_DAILY/各イベント群/NAMPA_ナンパ遊び.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/NAMPA_ナンパ遊び.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_NAMPA_RATE, EVENT_DAILY_NAMPA_DECISION, EVENT_DAILY_NAMPA_SETTARGET, SELECT_CHARA_RANDOM_LOGIC_DAILY_NAMPA, EVENT_DAILY_NAMPA_GENRE, EVENT_DAILY_NAMPA; UI/print
...
CALL SELECT_CHARA_RANDOM("DAILY_NAMPA")
...
@SELECT_CHARA_RANDOM_LOGIC_DAILY_NAMPA(対象)
#DIM 対象
RETURN CFLAG:対象:所属 == CFLAG:MASTER:所属 && !CFLAG:対象:捕虜先 && CFLAG:対象:特殊状態 != 特殊状態_死亡 && !(GETBIT(TALENT:対象:デイリー系, 素質_デイリー_援交少女)) && IS_FEMALE(対象) && ABL:対象:性知識 > 0
...
ELSEIF RESULT == 0
	...
	ELSEIF RESULT == 0
		...
		CALL FUCK(対象, "Ｃ, Ｂ, Ｖ, Ｍ, Ａ, Ｖ性交, Ａ性交, 性交, 性技, 奉仕, 精愛, 口淫, 欲望", "キス喪失, 処女喪失, Ａ処女喪失, 口内射精", 0, @"援交親父の\@RAND:2 ? ペニス # 唇\@", "援交親父", "", "売春")
		CALL FUCK(対象, "Ｃ, Ｂ, Ｖ, Ｍ, Ａ, Ｖ性交, Ａ性交, 性交, 性技, 奉仕, 精愛, 口淫, 欲望", "キス喪失, 処女喪失, Ａ処女喪失, 口内射精", 0, @"援交親父の\@RAND:2 ? ペニス # 唇\@", "援交親父", "", "売春")
		PRINTFORML 
		...
		PRINTFORML 
		CALL COLOR_PRINTW(@"%ANAME(対象)%は援助交際をする事になった", カラー_ピンク)
