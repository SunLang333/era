# SYSTEM/EVENT_DAILY/各イベント群/DRUG_SEX_シャブセックス.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/DRUG_SEX_シャブセックス.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_DRUG_SEX_RATE, EVENT_DAILY_DRUG_SEX_DECISION, EVENT_DAILY_DRUG_SEX_GENRE, EVENT_DAILY_DRUG_SEX_SETTARGET, SELECT_CHARA_RANDOM_LOGIC_DAILY_DRUG_SEX, EVENT_DAILY_DRUG_SEX; UI/print
