# SYSTEM/EVENT_DAILY/各イベント群/TERRITORY_LOST_SPOT_猫の家.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/TERRITORY_LOST_SPOT_猫の家.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_TERRITORY_LOST_SPOT_RATE, EVENT_DAILY_TERRITORY_LOST_SPOT_DECISION, EVENT_DAILY_TERRITORY_LOST_SPOT_GENRE, EVENT_DAILY_TERRITORY_LOST_SPOT; UI/print
