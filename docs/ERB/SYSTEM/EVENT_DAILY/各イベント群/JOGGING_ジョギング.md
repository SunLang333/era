# SYSTEM/EVENT_DAILY/各イベント群/JOGGING_ジョギング.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/JOGGING_ジョギング.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_JOGGING_RATE, EVENT_DAILY_JOGGING_DECISION, EVENT_DAILY_JOGGING_GENRE, EVENT_DAILY_JOGGING_SETTARGET, EVENT_DAILY_JOGGING; UI/print
