# SYSTEM/EVENT_DAILY/各イベント群/HYPNOTISM_WORKER_お仕事の誘い.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/HYPNOTISM_WORKER_お仕事の誘い.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_HYPNOTISM_WORKER_RATE, EVENT_DAILY_HYPNOTISM_WORKER_DECISION, EVENT_DAILY_HYPNOTISM_WORKER_GENRE, EVENT_DAILY_HYPNOTISM_WORKER, SELECT_CHARA_LIST_SHOW_LOGIC_HYPNOTISM_WORKER, SELECT_CHARA_LIST_SELECT_LOGIC_HYPNOTISM_WORKER, EVENT_DAILY_HYPNOTISM_WORKER_ALLOW_WHEN_WANDERING; UI/print
