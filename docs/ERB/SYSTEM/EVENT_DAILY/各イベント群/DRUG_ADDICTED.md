# SYSTEM/EVENT_DAILY/各イベント群/DRUG_ADDICTED.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/DRUG_ADDICTED.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_DRUG_ADDICT_RATE, EVENT_DAILY_DRUG_ADDICT_DECISION, EVENT_DAILY_DRUG_ADDICT_GENRE, EVENT_DAILY_DRUG_ADDICT_SETTARGET, EVENT_DAILY_DRUG_ADDICT, EVENT_DAILY_DRUG_ADDICT_ALLOW_WHEN_WANDERING; UI/print
	...
	SELECTCASE RAND:13
		...
		CASE 10
			...
			IF CFLAG:対象:所属 == CFLAG:MASTER:所属
				CALL COLOR_PRINTL("金1を手に入れた", カラー_注意)
				MONEY += 1
			ENDIF
			竿役 = ごろつき
		CASE 11
