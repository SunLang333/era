# SYSTEM/EVENT_DAILY/各イベント群/YAKUZA_やくざ.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/YAKUZA_やくざ.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_YAKUZA_RATE, EVENT_DAILY_YAKUZA_DECISION, EVENT_DAILY_YAKUZA_GENRE, EVENT_DAILY_YAKUZA, SELECT_CHARA_LIST_SHOW_LOGIC_YAKUZA, SELECT_CHARA_LIST_SHOW_LOGIC_YAKUZA_TARGET; UI/print
