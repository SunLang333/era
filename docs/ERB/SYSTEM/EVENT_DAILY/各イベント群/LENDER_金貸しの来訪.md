# SYSTEM/EVENT_DAILY/各イベント群/LENDER_金貸しの来訪.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/LENDER_金貸しの来訪.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_LENDER_RATE, EVENT_DAILY_LENDER_DECISION, EVENT_DAILY_LENDER_GENRE, EVENT_DAILY_LENDER; UI/print
