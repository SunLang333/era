# SYSTEM/EVENT_DAILY/各イベント群/DOCTOR_GAIRAI_外界の医者.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/DOCTOR_GAIRAI_外界の医者.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_DOCTOR_GAIRAI_RATE, EVENT_DAILY_DOCTOR_GAIRAI_DECISION, EVENT_DAILY_DOCTOR_GAIRAI_GENRE, EVENT_DAILY_DOCTOR_GAIRAI; UI/print
