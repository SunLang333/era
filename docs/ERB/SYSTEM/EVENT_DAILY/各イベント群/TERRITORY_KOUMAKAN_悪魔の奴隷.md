# SYSTEM/EVENT_DAILY/各イベント群/TERRITORY_KOUMAKAN_悪魔の奴隷.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/TERRITORY_KOUMAKAN_悪魔の奴隷.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_TERRITORY_KOUMAKAN_RATE, EVENT_DAILY_TERRITORY_KOUMAKAN_DECISION, EVENT_DAILY_TERRITORY_KOUMAKAN_GENRE, EVENT_DAILY_TERRITORY_KOUMAKAN; UI/print
...
ELSE
	...
	ELSEIF RESULT == 2
		...
		ENDSELECT
		CALL FUCK(MASTER, "欲望, 奉仕, 性技, 性交, 精愛, Ｃ, Ｖ, Ｂ, Ｍ, Ｖ性交, 口淫", "キス喪失, 処女喪失, 膣内射精, 口内射精, CFLAG減少", GET_SPERM_ID("ホフゴブリン"), @"ホフゴブリンの\@RAND:2 ? ペニス # 唇\@", "ホフゴブリン", "", "調教")
		PRINTFORML 
