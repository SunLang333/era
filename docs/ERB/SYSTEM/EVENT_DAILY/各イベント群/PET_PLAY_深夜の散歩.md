# SYSTEM/EVENT_DAILY/各イベント群/PET_PLAY_深夜の散歩.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/PET_PLAY_深夜の散歩.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_PET_PLAY_RATE, EVENT_DAILY_PET_PLAY_DECISION, EVENT_DAILY_PET_PLAY_GENRE, EVENT_DAILY_PET_PLAY, SELECT_CHARA_LIST_SHOW_LOGIC_PET_PLAY, SELECT_CHARA_LIST_COLOR_LOGIC_PET_PLAY; UI/print
...
SELECTCASE RAND:12
	...
	CASE 6
		PRINTFORML 静まった宮殿の一角からくぐもった声が聞こえてくる
	...
	CASE 8
		PRINTFORML %ANAME(対象)%を連れて宮殿内の散歩をすることにした
