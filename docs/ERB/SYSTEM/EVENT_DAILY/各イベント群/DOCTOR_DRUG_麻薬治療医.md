# SYSTEM/EVENT_DAILY/各イベント群/DOCTOR_DRUG_麻薬治療医.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/各イベント群/DOCTOR_DRUG_麻薬治療医.ERB`

类型: .ERB

自动摘要: functions: EVENT_DAILY_DOCTOR_DRUG_RATE, EVENT_DAILY_DOCTOR_DRUG_DECISION, EVENT_DAILY_DOCTOR_DRUG_GENRE, EVENT_DAILY_DOCTOR_DRUG, SELECT_CHARA_LIST_SHOW_LOGIC_DOCTOR_DRUG, SELECT_CHARA_LIST_COLOR_LOGIC_DOCTOR_DRUG; UI/print
...
CALL COLOR_PRINT("外界の医者が訪ねてきました", カラー_注意)
PRINTFORML
PRINTFORMW 「よう」
