# SYSTEM/EVENT_DAILY/EVENT_DAILY.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/EVENT_DAILY.ERB`

类型: .ERB

自动摘要: functions: IS_DAILY_EVENT_HAPPEN, DAILY_EVENT_RAND_CHARASELECT, SELECT_CHARA_RANDOM_LOGIC_DAILY_EVENT_RAND_CHARASELECT_OUR_COUNTRY, SELECT_CHARA_RANDOM_LOGIC_DAILY_EVENT_RAND_CHARASELECT_ALL, DAILY_EVENT_RAND_CITYSELECT, DAILY_EVENT_RAND_COUNTRYSELECT; assigns RESULTS; UI/print
