# SYSTEM/EVENT_DAILY/FUNCTION_DAILY.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_DAILY/FUNCTION_DAILY.ERB`

类型: .ERB

自动摘要: functions: DAILY_GET_DISABLE_CONFIG, DAILY_SET_DISABLE, REGISTER_DAILY; UI/print
