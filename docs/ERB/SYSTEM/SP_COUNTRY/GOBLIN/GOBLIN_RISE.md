# SYSTEM/SP_COUNTRY/GOBLIN/GOBLIN_RISE.ERB — 自动生成文档

源文件: `ERB/SYSTEM/SP_COUNTRY/GOBLIN/GOBLIN_RISE.ERB`

类型: .ERB

自动摘要: functions: GOBLIN_RISE_RATE, GOBLIN_RISE, GOBLIN_RISE_SELECT_CITY, GOBLIN_RISE_MSG; UI/print
...
CALL SP_COUNTRY_RISE(ホフゴブリン, 都市)
...
PRINTFORMW 彼らは反旗を翻し、%CITY_NAME:(対象)%\@ GET_OWN_CITY(勢力) > 1 ? など # \@を占拠したようです
