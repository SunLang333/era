# SYSTEM/SP_COUNTRY/GOBLIN/REV_TRAIN_GOBLIN.ERB — 自动生成文档

源文件: `ERB/SYSTEM/SP_COUNTRY/GOBLIN/REV_TRAIN_GOBLIN.ERB`

类型: .ERB

自动摘要: functions: GOBLIN_REV_TRAIN_REGULAR_EVENT, GOBLIN_REV_TRAIN_MSG, GOBLIN_REV_TRAIN_CHOOSE_PARTICIPANT; UI/print
