# SYSTEM/SP_COUNTRY/GOBLIN/GOBLIN_TRAIN_FUNCTIONS.ERB — 自动生成文档

源文件: `ERB/SYSTEM/SP_COUNTRY/GOBLIN/GOBLIN_TRAIN_FUNCTIONS.ERB`

类型: .ERB

自动摘要: functions: GOBLIN_DOES_TRAIN, GOBLIN_FALLEN_MSG, GOBLIN_FALLEN_LEAVE_MARK; UI/print
