# SYSTEM/SP_COUNTRY/GAIRAI/GAIRAI_FUNCTIONS.ERB — 自动生成文档

源文件: `ERB/SYSTEM/SP_COUNTRY/GAIRAI/GAIRAI_FUNCTIONS.ERB`

类型: .ERB

自动摘要: functions: TURNEND_GAIRAI, GAIRAI_DESTROY_MSG, GAIRAI_INIT, START_TRAIN_COMMON_GAIRAI, SELECT_CHARA_RANDOM_LOGIC_GAIRAI_BRAINCONTROL, GAIRAI_BRAINCONTROL, MASTER_CAPTURED_GAIRAI, GAIRAI_ENDING; UI/print
