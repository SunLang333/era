# SYSTEM/SP_COUNTRY/SUCCUBUS/REV_TRAIN_SUCCUBUS.ERB — 自动生成文档

源文件: `ERB/SYSTEM/SP_COUNTRY/SUCCUBUS/REV_TRAIN_SUCCUBUS.ERB`

类型: .ERB

自动摘要: functions: SUCCUBUS_REV_TRAIN_REGULAR_EVENT, SUCCUBUS_REV_TRAIN_MSG; UI/print
...
;定期イベント
;-------------------------------------------------
@SUCCUBUS_REV_TRAIN_REGULAR_EVENT(勢力)
#DIM 勢力
...
IF RESULT == 0
	...
	CALL COLOR_PRINTW(@"そして%ANAME(MASTER)%を、夢魔として生まれ変わらせた……", カラー_ピンク)
...
;知り合いがきたときのイベント
;-------------------------------------------------
@SUCCUBUS_REV_TRAIN_MSG(勢力, 知り合い参加者, 知り合い参加数)
#DIM 勢力
#DIM REF 知り合い参加者
#DIM 知り合い参加数
...
PRINTFORMW かつての%ANAME(知り合い参加者:0, 知り合い参加数)%ではない。どうやら夢魔になり果ててしまったようだ
PRINTFORMW 淫蕩な視線は、%ANAME(MASTER)%のからだに注がれている……
PRINTFORMW サキュバスはニコニコ笑いながら、お知り合いとシたほうが気持ちよくなれるわ、と言ってきた
PRINTFORMW さあ楽しみましょう。サキュバスがそのように言うと、%ANAME(知り合い参加者:0, 知り合い参加数)%は%ANAME(MASTER)%に群がった……
```
