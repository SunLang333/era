# SYSTEM/SP_COUNTRY/SUCCUBUS/SUCCUBUS_FUNCTIONS.ERB — 自动生成文档

源文件: `ERB/SYSTEM/SP_COUNTRY/SUCCUBUS/SUCCUBUS_FUNCTIONS.ERB`

类型: .ERB

自动摘要: functions: TURNEND_SUCCUBUS, SUCCUBUS_DESTROY_MSG, SUCCUBUS_INIT, START_TRAIN_COMMON_SUCCUBUS, SELECT_CHARA_RANDOM_LOGIC_SUCCUBUS_DRAIN, SUCCUBUS_DRAIN, MASTER_CAPTURED_SUCCUBUS, SUCCUBUS_ENDING; UI/print
