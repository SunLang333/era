# SYSTEM/SP_COUNTRY/SP_COUNTRY.ERH — 自动生成文档

源文件: `ERB/SYSTEM/SP_COUNTRY/SP_COUNTRY.ERH`
...
#DIMS CONST SP_COUNTRY_NAME = "", "野盗", "ホフゴブリン", "外来人", "触手", "自警団", "サキュバス", "狂信者"
#DIMS CONST SP_COUNTRY_NAME_ENG = "", "BANDIT", "GOBLIN", "GAIRAI", "TENTACLE", "VIGILANTE", "SUCCUBUS", "CULTIST"
#DIMS CONST SP_FALLEN_TALENT_NAME = "", "野盗の性奴隷", "ホフゴブリンの肉便器", "実験動物", "触手による寄生", "自警団員", "淫魔", "狂信者"
