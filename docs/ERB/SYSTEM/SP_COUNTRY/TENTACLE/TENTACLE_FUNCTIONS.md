# SYSTEM/SP_COUNTRY/TENTACLE/TENTACLE_FUNCTIONS.ERB — 自动生成文档

源文件: `ERB/SYSTEM/SP_COUNTRY/TENTACLE/TENTACLE_FUNCTIONS.ERB`

类型: .ERB

自动摘要: functions: TURNEND_TENTACLE, TENTACLE_DESTROY_MSG, TENTACLE_INIT, SELECT_CHARA_RANDOM_LOGIC_TENTACLE_FORCE_PREGNANT, TENTACLE_FORCE_PREGNATE, MASTER_CAPTURED_TENTACLE, TENTACLE_ENDING; UI/print
