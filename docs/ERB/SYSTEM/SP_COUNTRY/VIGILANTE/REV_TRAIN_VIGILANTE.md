# SYSTEM/SP_COUNTRY/VIGILANTE/REV_TRAIN_VIGILANTE.ERB — 自动生成文档

源文件: `ERB/SYSTEM/SP_COUNTRY/VIGILANTE/REV_TRAIN_VIGILANTE.ERB`

类型: .ERB

自动摘要: functions: VIGILANTE_REV_TRAIN_REGULAR_EVENT, VIGILANTE_REV_TRAIN_MSG, VIGILANTE_REV_TRAIN_CHOOSE_PARTICIPANT; UI/print
