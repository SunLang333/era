# SYSTEM/SP_COUNTRY/SP_COUNTRY_FUNCTIONS.ERB — 自动生成文档

源文件: `ERB/SYSTEM/SP_COUNTRY/SP_COUNTRY_FUNCTIONS.ERB`

类型: .ERB

自动摘要: functions: SP_TRAIN_IS_DECREASE_CFLAG, SP_CHARA_TO_SPERM_ID, IS_SP_COUNTRY, IS_TRAIN_BY_SP_COUNTRY, IS_BETRAY_TO_SP_COUNTRY, IS_FALLEN_TO_SP_COUNTRY, PLAYER_FALLEN_TO_SP_COUNTRY, IS_SP_COUNTRY_CHARA, SP_COUNTRY_TO_CONST, SP_COUNTRY_ID_TO_COSNT, CHECK_SP_COUNTRY_RISE, CREATE_SP_COUNTRY, INIT_SP_COUNTRY
