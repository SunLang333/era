# SYSTEM/SP_COUNTRY/BANDIT/REV_TRAIN_BANDIT.ERB — 自动生成文档

源文件: `ERB/SYSTEM/SP_COUNTRY/BANDIT/REV_TRAIN_BANDIT.ERB`

类型: .ERB

自动摘要: functions: BANDIT_REV_TRAIN_SP_EVENT, BANDIT_REV_TRAIN_REGULAR_EVENT, BANDIT_REV_TRAIN_MSG, BANDIT_REV_TRAIN_CHOOSE_PARTICIPANT; UI/print
