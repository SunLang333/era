# SYSTEM/SP_COUNTRY/BANDIT/BANDIT_FUNCTIONS.ERB — 自动生成文档

源文件: `ERB/SYSTEM/SP_COUNTRY/BANDIT/BANDIT_FUNCTIONS.ERB`

类型: .ERB

自动摘要: functions: TURNEND_BANDIT, BANDIT_INIT, START_TRAIN_COMMON_BANDIT, TREAT_PRISONER_BANDIT, MASTER_CAPTURED_BANDIT, BANDIT_ENDING; UI/print
