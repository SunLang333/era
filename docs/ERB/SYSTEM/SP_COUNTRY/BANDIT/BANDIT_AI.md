# SYSTEM/SP_COUNTRY/BANDIT/BANDIT_AI.ERB — 自动生成文档

源文件: `ERB/SYSTEM/SP_COUNTRY/BANDIT/BANDIT_AI.ERB`

类型: .ERB

自动摘要: functions: BANDIT_AI, BANDIT_ADD_SOLDIER, BANDIT_CLEAR_UNIT, BANDIT_CREATE_UNIT; UI/print
