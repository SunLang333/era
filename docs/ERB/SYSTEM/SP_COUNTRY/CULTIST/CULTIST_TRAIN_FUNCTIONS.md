# SYSTEM/SP_COUNTRY/CULTIST/CULTIST_TRAIN_FUNCTIONS.ERB — 自动生成文档

源文件: `ERB/SYSTEM/SP_COUNTRY/CULTIST/CULTIST_TRAIN_FUNCTIONS.ERB`

类型: .ERB

自动摘要: functions: CULTIST_DOES_TRAIN, CULTIST_FALLEN_MSG, CULTIST_FALLEN_LEAVE_MARK; UI/print
