# SYSTEM/EVENT_MORNING.ERB — 自动生成文档

源文件: `ERB/SYSTEM/EVENT_MORNING.ERB`

类型: .ERB

自动摘要: functions: EVENT_MORNING, EVENT_MORNING_SP
...
ELSE
	...
	FOR LOCAL:0, 0, CHARANUM
		IF LOCAL:0 != MASTER && TALENT:(LOCAL:0):恋慕 && GROUPMATCH(ABL:(LOCAL:0):性知識, 1, 2) && !TALENT:(LOCAL:0):虚ろ && CFLAG:(LOCAL:0):特殊状態 == 0 && CFLAG:(LOCAL:0):捕虜先 == 0
