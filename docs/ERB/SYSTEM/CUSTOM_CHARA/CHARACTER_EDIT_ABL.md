# SYSTEM/CUSTOM_CHARA/CHARACTER_EDIT_ABL.ERB — 自动生成文档

源文件: `ERB/SYSTEM/CUSTOM_CHARA/CHARACTER_EDIT_ABL.ERB`

类型: .ERB

自动摘要: functions: CHARACTER_EDIT_INPUT_ABL; UI/print
...
PRINTFORML 値を入力 現在値{ABL:対象:入力値} 
PRINTFORML %ABLNAME:入力値%を編集中 {ABL_MIN:入力値}～{ABL_MAX:入力値})
