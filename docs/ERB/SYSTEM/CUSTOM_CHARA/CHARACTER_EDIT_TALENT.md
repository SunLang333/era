# SYSTEM/CUSTOM_CHARA/CHARACTER_EDIT_TALENT.ERB — 自动生成文档

源文件: `ERB/SYSTEM/CUSTOM_CHARA/CHARACTER_EDIT_TALENT.ERB`

类型: .ERB

自动摘要: functions: CHARACTER_EDIT_INPUT_TALENT, CHARACTER_EDIT_IGNORE_TALENT; UI/print
...
#DIM 入力値
;ガード節
SIF (CHARACTER_EDIT_IGNORE_TALENT(入力値) && !GROUPMATCH(入力値, GETNUM(TALENT, "処女"), GETNUM(TALENT, "アナル処女"), GETNUM(TALENT, "キス未経験"), GETNUM(TALENT, "童貞"), GETNUM(TALENT, "危険日"))) || TALENTNAME:入力値 == ""
	RETURN 0
...
#FUNCTION
{
	RETURNF GROUPMATCH(ARG:0, GETNUM(TALENT, "性別"), GETNUM(TALENT, "処女"), GETNUM(TALENT, "アナル処女"), GETNUM(TALENT, "キス未経験"), GETNUM(TALENT, "童貞"), GETNUM(TALENT, "恋慕"), GETNUM(TALENT, "親愛"), GETNUM(TALENT, "恋人"), GETNUM(TALENT, "服従"), GETNUM(TALENT, "隷属"), GETNUM(TALENT, "烙印"), GETNUM(TALENT, "親友"), GETNUM(TALENT,"主人"), GETNUM(TALENT,"所有者"),
