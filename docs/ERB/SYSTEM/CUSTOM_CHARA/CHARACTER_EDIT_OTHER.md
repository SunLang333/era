# SYSTEM/CUSTOM_CHARA/CHARACTER_EDIT_OTHER.ERB — 自动生成文档

源文件: `ERB/SYSTEM/CUSTOM_CHARA/CHARACTER_EDIT_OTHER.ERB`

类型: .ERB

自动摘要: functions: CHARACTER_EDIT_INPUT_OTHER; UI/print
