# SKILLS/148_隠岐奈/SKILL_隠岐奈_PERSONAL_1_裏切りの援護射撃.ERB — 自动生成文档

源文件: `ERB/SKILLS/148_隠岐奈/SKILL_隠岐奈_PERSONAL_1_裏切りの援護射撃.ERB`

类型: .ERB

自动摘要: functions: SKILL_148_PERSONAL_1_EXIST, SKILL_148_PERSONAL_1_NAME, SKILL_148_PERSONAL_1_LEVEL, SKILL_148_PERSONAL_1_SETTARGET, SKILL_148_PERSONAL_1_CAN_INVOKE, SKILL_148_PERSONAL_1_INVOKE, SKILL_148_PERSONAL_1_CANT_TELL, SKILL_148_PERSONAL_1_EXPLANATION, SKILL_148_PERSONAL_1_RATE; assigns RESULTS; UI/print
...
PRINTFORML \@ 君主 >= 0 ? %ANAME(君主)% # 敵 \@軍の兵が、次々%ANAME(発動者)%に寝返った！
