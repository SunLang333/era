# SKILLS/0_汎用/SP/SKILL_PERSONAL_28_弁舌＋.ERB — 自动生成文档

源文件: `ERB/SKILLS/0_汎用/SP/SKILL_PERSONAL_28_弁舌＋.ERB`

类型: .ERB

自动摘要: functions: SKILL_0_PERSONAL_28_EXIST, SKILL_0_PERSONAL_28_NAME, SKILL_0_PERSONAL_28_LEVEL, SKILL_0_PERSONAL_28_SETTARGET, SKILL_0_PERSONAL_28_CAN_INVOKE, SKILL_0_PERSONAL_28_INVOKE, SKILL_0_PERSONAL_28_EXPLANATION, SKILL_0_PERSONAL_28_RATE; assigns RESULTS; UI/print
...
@SKILL_0_PERSONAL_28_RATE(発動者, 発動番号, 発動側, 発動勢力, 発動部隊, 対象勢力, 対象部隊)
#DIM 発動者
#DIM 発動番号
#DIM スキル
#DIMS ジャンル
