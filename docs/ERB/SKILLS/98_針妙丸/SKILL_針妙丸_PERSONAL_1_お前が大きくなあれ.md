# SKILLS/98_針妙丸/SKILL_針妙丸_PERSONAL_1_お前が大きくなあれ.ERB — 自动生成文档

源文件: `ERB/SKILLS/98_針妙丸/SKILL_針妙丸_PERSONAL_1_お前が大きくなあれ.ERB`

类型: .ERB

自动摘要: functions: SKILL_98_PERSONAL_1_EXIST, SKILL_98_PERSONAL_1_NAME, SKILL_98_PERSONAL_1_LEVEL, SKILL_98_PERSONAL_1_SETTARGET, SKILL_98_PERSONAL_1_CAN_INVOKE, SKILL_98_PERSONAL_1_INVOKE, SKILL_98_PERSONAL_1_EXPLANATION, SKILL_98_PERSONAL_1_CANT_TELL, SKILL_98_PERSONAL_1_RATE; assigns RESULTS; UI/print
...
#DIM 対象部隊
対象側 = !発動側
PRINTFORML 大きくなった%ANAME(BATTLE_COMMANDER:対象側:COMBAT_SKILL_TARGET)%の武闘が増加！
TIMES BATTLE_武闘パワー:対象側:COMBAT_SKILL_TARGET, 1.15
RETURN 1

;
@SKILL_98_PERSONAL_1_EXPLANATION
RESULTS = 敵一人の武闘を増加させる。
