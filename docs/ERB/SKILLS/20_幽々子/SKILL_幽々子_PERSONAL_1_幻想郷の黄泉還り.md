# SKILLS/20_幽々子/SKILL_幽々子_PERSONAL_1_幻想郷の黄泉還り.ERB — 自动生成文档

源文件: `ERB/SKILLS/20_幽々子/SKILL_幽々子_PERSONAL_1_幻想郷の黄泉還り.ERB`

类型: .ERB

自动摘要: functions: SKILL_20_PERSONAL_1_EXIST, SKILL_20_PERSONAL_1_NAME, SKILL_20_PERSONAL_1_LEVEL, SKILL_20_PERSONAL_1_SETTARGET, SKILL_20_PERSONAL_1_CAN_INVOKE, SKILL_20_PERSONAL_1_INVOKE, SKILL_20_PERSONAL_1_EXPLANATION, SKILL_20_PERSONAL_1_CANT_TELL, SKILL_20_PERSONAL_1_RATE; assigns RESULTS; UI/print
...
#DIM 対象部隊
対象側 = !発動側
PRINTFORML %ANAME(BATTLE_COMMANDER:発動側:COMBAT_SKILL_TARGET)%は戦闘に復帰した！
